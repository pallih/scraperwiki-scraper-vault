...
query = "race_date, races.race_name as race_name, races.results_url as race_url, race_division, name_1 AS name, div_1 AS division, class_1 as class, name_2 AS partner_name, club_2 AS partner_club, position, time, retired, p_d_1 as p_d from results INNER JOIN races ON races.results_url=results.race_name WHERE club_1='" + club + "' AND race_date LIKE '____-%' AND race_date >= '" + str(hasler_year-1) + "-09' AND race_date < '" + str(hasler_year) + "-09' AND races.race_name <> 'Hasler Final' AND races.race_name NOT LIKE 'National Marathon Championshipssss' AND time <> 'dsq' AND time <> 'dns' UNION SELECT race_date, races.race_name as race_name, races.results_url as race_url, race_division, name_2 AS name, div_2 AS division, class_2 as class, name_1 AS partner_name, club_1 AS partner_club, position, time, retired, p_d_2 as p_d from results INNER JOIN races ON races.results_url=results.race_name WHERE club_2='" + club + "' AND race_date LIKE '____-%' AND race_date >= '" + str(hasler_year-1) + "-09' AND race_date < '" + str(hasler_year) + "-09' AND races.race_name <> 'Hasler Final' AND races.race_name NOT LIKE 'National Marathon Championships' AND time <> 'dsq' AND time <> 'dns' ORDER BY name, race_date"
