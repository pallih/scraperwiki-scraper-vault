...
for n in range(1, last_page + 1):
    ...
    soup = BeautifulSoup(html)
#on the search results page find the URLs of each of the results, search for '<a' tag and class 'notice-title (first argument always tag, second always class) overrule explicit argument statements
    ...
    for link in links:
#that means all element in a list
        url = link["href"]
        print url
