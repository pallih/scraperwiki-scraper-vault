...
for year in years:
    ...
    for row in rows:
        ...
        if len(tds):
            ...
            scraperwiki.sqlite.save(unique_keys=["date"], data={"circuit":track, "driver1":pilots[0], "team1":cars[0],"driver2":pilots[1], "team2":cars[1], "driver3":pilots[2], "team3":cars[2], "date":date, "year":year})import scraperwiki
import datetime
