...
for h in range(35):
    if(h<10):
        myString=str(0)+str(h+1)
        
    else:
        myString=str(h)
    url="http://censusindia.gov.in/Census_Data_2001/Village_Directory/List_of_Villages/List_of_Villages_Alphabetical.aspx?cki=&State_Code="+myString+""
    import string
