    ...
    def copy_items_from_feed(self):
        ...
        for item in self._feed[ "items" ]:
            ...
            if(not (tmp in self._items)):
                ...
                print len(scraperwiki.sqlite.execute("select post from hn where post = '" + tmp.get_link_to_post() + "'")[ "data" ]) == 0
...
scraper.read_feed()
scraper.copy_items_from_feed()import scraperwiki
import feedparser
import time
