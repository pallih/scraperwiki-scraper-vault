...
# print "Found %d friends of %s" % (len(friends_json), SCREENNAME)
friends_json = friends_json['ids'] # get earliest friends first for batching
...
c = 0
for friends_list in group(friends_json, 100):
    c = c + 1
    if c < batchstart:
        continue
    # print "number", c, "out of", len(friends_json) / 100
