# Metacritic Scraper - Based on David's 'Metacritic All Xbox360' scraper
import scraperwiki
import lxml.html
import re
...
for type in types:
    ...
    for product in products:
        ...
        product_image = product.xpath("div/div[@class='product_basics product_image small_image']/a/img[@class='product_image small_image']/@src")
        ...
        data['type'] = type
        if data['score'] > 85:
            scraperwiki.datastore.save(unique_keys=['title','image','url','rating','release','genre','publisher'], data=data)
# Metacritic Scraper - Based on David's 'Metacritic All Xbox360' scraper
import scraperwiki
import lxml.html
import re
