...
print 'Scraped %d records' % count# Created at Python Northwest, Manchester, 2010-11-15
...
# retrieve a page
starting_url = 'https://www.whatdotheyknow.com/request/49024/response/124689/attach/3/FOI%202010%20207%20Jones.xls'
book = xlrd.open_workbook(file_contents=scraperwiki.scrape(starting_url))
XL_EPOCH = datetime.date(1899, 12, 30)
scraperwiki.metadata.save('data_columns', ['Date', 'tmin', 'tmax', 'tmean'])
