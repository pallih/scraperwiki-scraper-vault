# Blank Python
###############################################################################
# New York- Labor Organizations (Python Version)
#
...
FIRST_EXT = '/ny/Labor_Organizations?g=NY'
MAX_PAGES    = 0  ## set to 0 for unlimited
CURRENT_PAGE = 0  ## keeps track of current page
DATA_KEY     = 1  ## since we don't have unique business_names,
                  ## we need another unique key
...
scrape_and_look_for_next_link(starting_url)# Blank Python
###############################################################################
# New York- Labor Organizations (Python Version)
#
# This script starts on the first page and then
