...
for pageNo in range (1, 4):
    ...
    html = scraperwiki.scrape("http://www.sify.com/movies/moreheadlines/category/malayalam/page/"+ str(pageNo) +".html")
    ...
    for i in range(0, len(bw_news_titles)):
        if bw_news_details[i].text_content() != "":
            ...
            'sourceUrl':'http://www.sify.com/',
            'sourceLogo':'http://im.sify.com/fullstory/fullstory-revised-2011/images/movies-logo.png'
            }         
