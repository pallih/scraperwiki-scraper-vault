...
xml = scraperwiki.scrape("http://eu-parlameter.zdf.de/ep11/data_abst_liste.php") 
...
for data in root.cssselect("data"): 
   ...
   d['link'] = 'http://eu-parlameter.zdf.de/?abstID=' + d['ID'];
   scraperwiki.sqlite.save(unique_keys=['ID'], data=d)


xml = scraperwiki.scrape("http://eu-parlameter.zdf.de/ep11/data_abg_liste.php?period=17&orderby=sortName")
root = lxml.html.fromstring(xml)
