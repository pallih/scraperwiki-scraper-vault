...
$prov_calabria = array("CATANZARO","COSENZA","CROTONE","REGGIO%20CALABRIA","VIBO%20VALENTIA");
...
# Use the PHP Simple HTML DOM Parser to extract <td> tags
  $main_url="http://www.trampi.istruzione.it/ricScu/cerca.do?";
    ...
    foreach($prov_calabria as $prov){
                $url=$main_url."regione=CALABRIA&provincia=".$prov."&comune=&tipologia=".$tipo."&denominazione=&codicemecc=&order=DES_NOM";
                    print $url."\n";
