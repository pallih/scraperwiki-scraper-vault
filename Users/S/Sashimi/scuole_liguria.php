...
$prov_liguria = array("GENOVA","IMPERIA","LA%20SPEZIA","SAVONA");
...
# Use the PHP Simple HTML DOM Parser to extract <td> tags
 $main_url="http://www.trampi.istruzione.it/ricScu/cerca.do?";   
     ...
     foreach($prov_liguria as $prov){
                 $url=$main_url."regione=LIGURIA&provincia=".$prov."&comune=&tipologia=".$tipo."&denominazione=&codicemecc=&order=DES_NOM";
                     print $url."\n";
