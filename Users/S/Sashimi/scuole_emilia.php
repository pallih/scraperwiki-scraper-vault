...
$prov_emilia_paranoica = array("BOLOGNA","FERRARA","FORLI'","MODENA","PARMA","PIACENZA","RAVENNA","REGGIO%20EMILIA","RIMINI");
...
# Use the PHP Simple HTML DOM Parser to extract <td> tags
 $main_url="http://www.trampi.istruzione.it/ricScu/cerca.do?";   
     ...
     foreach($prov_emilia_paranoica as $prov){
                 $url=$main_url."regione=EMILIA%20ROMAGNA&provincia=".$prov."&comune=&tipologia=".$tipo."&denominazione=&codicemecc=&order=DES_NOM";
                     print $url."\n";
