...
gid = j = 0
season = "2007-2008s"
gidarray = [20164,    20175,    20176,    20188,    20189,    20205,    20212,    20225,    20234,    20264,    20280,    20294,    20311,    20325,    20359,    20371,    20374,    20392,    20422,    20442,    20493,    20518,    20547,    20562,    20597,    20609,    20613,    20631,    20645,    20659,    20670,    20693,    20708,    20709,    20730,    20761,    20775,    20784,    20797,    20807,    20819,    20820,    20836,    20854,    20882,    20883,    20904,    20905,    20921,    20922,    20936,    20949,    20954,    20980,    20981,    21050,    21051,    21065,    21080,    21099,    21111,    21127,    21128,    21137,    21156,    21192,    21204,    21214,    21220]

#for gid in range((scraperwiki.sqlite.get_var('gid') + 1),21231):
for gid in gidarray:
    scraperwiki.sqlite.save_var('gid', gid)
    url = "http://www.nhl.com/scores/htmlreports/20072008/GS0" + str(gid) + ".HTM"
...
# Get PPTime
    ...
    for td in tds: # iterate over each of the <td> elements (i.e. elements of the list called "tds")
        #print i, td.text
        try:
            if 'POWER PLAYS (Goals-Occurrences / Time)' in td.text or 'POWER PLAYS (Goals-Occurrences/Time)' in td.text or 'POWER PLAYS (Goals-Opp. / Power Play Time)' in td.text or 'POWER PLAYS (Goals-Opp./Power Play Time)' in td.text or 'POWERPLAYS (Goals-Opp. / Power Play Time)' in td.text or 'POWERPLAYS (Goals-Opp./Power Play Time)' in td.text:
                PPT[3] = tds[i+7].text
                PPT[4] = tds[i+8].text
                PPT[5] = tds[i+9].text
                PPT[0] = tds[i+16].text
            ...
            pass
        i += 1
    if 'EVEN STRENGTH (Goals-Occurences / Time)' in PPT:
        i = 0
        PPT = [0,0,0,0,0,0]
        for td in tds: # iterate over each of the <td> elements (i.e. elements of the list called "tds")
            #print i, td.text
