...
#for gid in range((scraperwiki.sqlite.get_var('gid') + 1),20720):
for gid in gidarray:
    ...
    for row in rows:
        ...
        if ((trs[1].text != "5") and trs[4].text == "GOAL") and (trs[2].text == "SH"):
            ...
            if ('G' in awayskate and 'G' in homeskate) and (trs[5].text.startswith(hometeam)) and (awayDcount == 1) and (homecount == 4) and (awaycount == 5):
                ...
                STeamAG1 += 1
            if ('G' in awayskate and 'G' in homeskate) and (trs[5].text.startswith(hometeam)) and (awayeDcount == 0) and (homecount == 4) and (awaycount == 5):
                STeamHG0 += 1
