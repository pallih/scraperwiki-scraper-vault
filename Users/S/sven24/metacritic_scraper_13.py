# Metacritic Scraper new game releases

import scraperwiki
import lxml.html
import re

types = ['games/release-date/new-releases/ps3', 'games/release-date/new-releases/xbox360', 'games/release-date/new-releases/pc', 'games/release-date/new-releases/ios', 'games/release-date/new-releases/wii',]
...
for type in types:
    ...
    for product in products:
        ...
        data['type'] = type
        scraperwiki.datastore.save(unique_keys=['title', 'url'], data=data)
