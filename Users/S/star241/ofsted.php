...
$url = "http://www.ofsted.gov.uk/inspection-reports/find-inspection-report/results/all/any/authority/301/any/any";
foreach ($authorities as $authorityID=>$authorityName) {
    $page = 0;
    while (true) {
        $dom->load(scraperwiki::scrape("http://www.ofsted.gov.uk/inspection-reports/find-inspection-report/results/all/any/authority/$authorityID/any/any?page=$page"));
