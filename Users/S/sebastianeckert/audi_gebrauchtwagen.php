...
$pageurl = "http://vtp.audi.com/agwb/controller.do?act=list&sid=6&selfAction=&tab=&sortBy=INITIAL_MANUF_PRICE&sortOrder=U&page={$page_counter}&v=0&show=&ixList=0&notepad=&lines=50&compare=&ixCheck=&func=Funktion+w%C3%A4hlen&lines2=50";
...
if (preg_match_all('#,\'0\'\)">Audi(.+?)5-Gang#',$html_data, $cars)) {
        $cars = $cars[1];
    }
