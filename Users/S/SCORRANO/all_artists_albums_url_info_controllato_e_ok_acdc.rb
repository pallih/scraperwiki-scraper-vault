...
rows.each do |row| #itero su ogni riga (cioè su ogni album)
  ...
  ScraperWiki::save_sqlite([:album_url], album, table_name="ALL_artist_albums_info", verbose=2) #salva il contenuto estratto per URL degli album (che saranno sempre diversi da artista ad artista)
