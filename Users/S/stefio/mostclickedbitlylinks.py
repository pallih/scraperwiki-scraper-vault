...
for x in range(1, 2):
    ...
    url = 'https://api-ssl.bitly.com/v3/search?access_token=56b48892f54baafc285151479ff06dc35ca82108&query=boston&fields=aggregate_link%2Ctitle%2Curl&limit=1000'
