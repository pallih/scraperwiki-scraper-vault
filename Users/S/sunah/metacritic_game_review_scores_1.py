    ...
    for url in urls:
        ...
        while current_url is not None:            
            ...
            if not next_a:
                ...
                current_url = "http://www.baseball-reference.com" + next_a[0].attrib['href']

urls = ["http://www.baseball-reference.com/awards/mvp_cya.shtml","http://www.baseball-reference.com"];
