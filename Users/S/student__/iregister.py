...
url = 'http://iregister.hpcsa.co.za/RegisterSearch.aspx'
...
for pagenum in range(10):
    ...
    mnextlink = re.search("javascript:setTimeout('__doPostBack(\'SearchChkb$5\',\'\')', 0)", html)
    print mnextlink
    if not mnextlink:
        break
