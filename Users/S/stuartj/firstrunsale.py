...
exchanges = {
    'Walton':   ('L9$','POSTCODE%5E25772'),
    'Anfield L4':   ('L4$','POSTCODE%5E2015'),
    'Anfield (Sunbury)':   ('L4 2TN$','POSTCODE%5E450156'),
    'Anfield (Lakes)':   ('L4 2QE$','POSTCODE%5E450123'),
    'Tuebrook L13':   ('L13$','POSTCODE%5E25129'),
    'Kirkdale L4':   ('L4$','POSTCODE%5E14293'),
    'Fairfield L6/L7 (urban)':   ('L6$','POSTCODE%5E9673'),

}

for exc, pcode in exchanges.iteritems():
    url = '/property-for-sale/find.html?locationIdentifier=' + pcode[1] + '&maxPrice=100000&minBedrooms=2&radius=1.0'
