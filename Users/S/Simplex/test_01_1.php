...
//create table
scraperwiki::sqliteexecute("drop table mikbaits");
scraperwiki::sqliteexecute("create table mikbaits (ID smallint, nazov varchar,kategoria varchar, cena varchar,zlavnena_cena varchar,perc_zlava smallint, vyrobca varchar,vaha varchar,short_detail varchar, detail varchar,image_url varchar)");
...
for($i=2500;$i<5000;$i++){
$url="http://mikbaits.eu/product.php?id_product=".$i;
...
$other_img_all .= "http://www.mikbaits.eu".$other_img. ",";   
}
//print $other_img;
...
scraperwiki::sqliteexecute("insert into mikbaits (ID, nazov,kategoria, cena,zlavnena_cena,perc_zlava,vyrobca,vaha,short_detail, detail, image_url) values ('$i', '$nazov','$xkategoria', '$cena','$zlavnena_cena','$perc_zlava','$vyrobca','','$short_detail','$detail_all','$imagex')");
scraperwiki::sqlitecommit();
