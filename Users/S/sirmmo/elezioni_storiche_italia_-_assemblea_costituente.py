                        ...
                        for l4 in h(level_finder):    
                            ...
                            for party in j('.dati tr').not_('.totalecomplessivovoti'):
                                ...
                                if len(k('th'))==1:
                                    ...
                                    data = {}
                                    scraperwiki.sqlite.save(unique_keys = keys, data= to_dict(keys, [date,safe_str(lev1),safe_str(lev2),safe_str(lev3), safe_str(lev4), elettori, votanti, safe_str(panme), votes ]))import scraperwiki
