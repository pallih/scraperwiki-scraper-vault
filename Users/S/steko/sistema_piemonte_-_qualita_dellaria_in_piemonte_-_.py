...
URL = "http://www.sistemapiemonte.it/ambiente/srqa/consultadati.shtml"
...
def get_stations(url):
    ...
    select = root.cssselect('select#stazione')[0]
...
#    for s in scripts:
#        if 'function Updateparamo() {' in s.text_content():
#            js = s.text_content()
#            js = [l.strip() for l in js.splitlines()]
