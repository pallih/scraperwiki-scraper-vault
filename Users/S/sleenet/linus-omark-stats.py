...
import scraperwiki
html = scraperwiki.scrape('http://theahl.com/stats/player.php?id=3737')
print html
...
ths = soup.findAll('th') # get all the <th> tags
for th in ths:
    print th # the full HTML tag
...
for th in ths:
     ...
     scraperwiki.datastore.save(["th"], record) # save the records one by one
for td in tds:
