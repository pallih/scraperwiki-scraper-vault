...
config = ["ActivEngage", "contactatonce", "btnChatButton", "liveperson", "ecarlist", "upsellit", "gubagoo","chat1gateway", "dealereprocesschat", "chatserver"] # Can add more strings here as you wish
...
get_source('http://salemove.com/wp-content/uploads/2013/04/Recheck_Chat.xls', config)import scraperwiki
import urllib2
import xlrd
from httplib import BadStatusLine
...
#    i += 1
#Uncomment the below when excel is ready
get_source('http://salemove.com/wp-content/uploads/2013/04/Recheck_Chat.xls', config)