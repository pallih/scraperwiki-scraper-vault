# Twitter feed without OAuth (let's get back to v1.0) / Code: Jake Berendes

html = ScraperWiki::scrape("https://twitter.com/search?q=%23%22XXX+XXX%22&count=1200&result_type=recent")
