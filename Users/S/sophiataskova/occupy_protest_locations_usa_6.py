...
index = 'http://en.wikipedia.org/w/api.php?action=parse&format=json&page=List_of_casinos_in_California';
...
for location in locations:
    print '(' + str(i) + '/' + str(len(locations)) + ') Geocoding ' + location['location'] + '...'
    ...
    print '(' + str(i) + '/' + str(len(locations)) + ') Saving ' + location['location'] + '...'
