...
$url = "http://en.600024.com/musicdirector/yuvan-shankar-raja-movies-list/page/".$pn."/";
$url = "http://en.600024.com/musicdirector/yuvan-shankar-raja-movies-list/";
...
foreach($dom->find('td[class="moviegrid"]') as $data)
{
   ...
   // print "\n"; 
    ...
    scraperwiki::save_sqlite(array("MovieName","MusicDirName","DirName"),$record,"YuvanDB");
}
}
