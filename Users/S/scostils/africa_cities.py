...
html = scraperwiki.scrape("http://en.wikipedia.org/wiki/List_of_cities_and_towns_in_Zimbabwe", "", useragent)
...
for a in root.cssselect("table.wikitable tr td:nth-child(2) a"):
    ...
    scraperwiki.sqlite.save(unique_keys=['city'], data=data) # -*- coding: iso-8859-1 -*-
import scraperwiki
import lxml.html
