...
def saveToStore(data):
    scraperwiki.sqlite.execute("CREATE TABLE IF NOT EXISTS steam_players ('ID' string, 'Location' string, 'Joined_Date' string, 'Real_Name' string, PRIMARY KEY('Real_Name'))")
