...
scraperwiki.sqlite.save_var("author", "Sergey Skurikhin")
...
def scrape_info(comp_link, num):
    ...
    #print data_list
    adress = data_list[5]+data_list[6]+data_list[8]

    my_data.append(('companyname', data_list[4]))
