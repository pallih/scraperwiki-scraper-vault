...
for ($i = 1; $i <= 5; $i++) {
    $html = scraperWiki::scrape("http://www.nhs.uk/Scorecard/Pages/Results.aspx?OrgType=2&Coords=3104%2c3981&TreatmentID=0&PageSize=0&TabId=30&SortType=1&LookupType=1&LocationType=1&SearchTerm=WS11+1BG&DistanceFrom=20&SortByMetric=0&TrustCode=&TrustName=&DisambiguatedSearchTerm=&LookupTypeWasSwitched=False&MatchedOrganisationPostcode=&MatchedOrganisationCoords=&ServiceIDs=&ScorecardTypeCode=&NoneEnglishCountry=&HasMultipleNames=False&OriginalLookupType=1&ServiceLaunchFrom=&Filters=&TopLevelFilters=&PageNumber=". $i);
