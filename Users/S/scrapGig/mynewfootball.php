...
$i=0;
    ...
    continue;
        ...
        $position = $xpath->query("//strong[.='Position:']/following::text()")->item(0)->nodeValue;
        ...
        $colleges = $xpath->query("//p/strong[.='College:']/following-sibling::a[starts-with(@href,'/colleges/')]/text()");
        $myCollege ="";
        foreach($colleges as $college){
            $myCollege.=$college->nodeValue;
        }
        ...
        scraperwiki::save_sqlite(array("index"),array("index"=>$i, "First name"=>$fName, "Last Name"=>$lName, "TwitterId"=>$twitterId,"Position"=>$position,"Birth Date"=>$birthDate,"college"=>$myCollege,"Team"=>$team,"Debut"=>$debut,"Death"=>$death, "Link"=>$givenLink));
    $i++;   
 }
?>
