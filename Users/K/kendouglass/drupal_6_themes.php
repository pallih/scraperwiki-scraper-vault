...
// Get page filtered by 6.x compatibility.
$uris = array(
   // 'modules' => "http://drupal.org/project/modules/index?project-status=0&drupal_core=87",
    'themes' => "http://drupal.org/project/themes/index?project-status=0&drupal_core=87",
   // 'profiles' => "http://drupal.org/project/installation%2Bprofiles/index?project-status=0&drupal_core=87",
);
