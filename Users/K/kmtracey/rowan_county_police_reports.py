...
starting_page = 'http://ossip2c.rowancountync.gov/p2c/Summary_Disclaimer.aspx'
...
def get_pages(day):
    ...
    br.addheaders = [('User-agent', 'Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:19.0) Gecko/20100101 Firefox/19.0')]
