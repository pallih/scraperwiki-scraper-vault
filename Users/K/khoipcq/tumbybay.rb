...
STARTING_URL = 'http://eservice.tumbybay.sa.gov.au/eservice/daEnquiryInit.do?nodeNum=3658'
SEARCH_URL = 'eservice.tumbybay.sa.gov.au/eservice/daEnquiry.do?number='
CHILD_URL = 'http://eservice.tumbybay.sa.gov.au'
...
COMMENT_URL_PREFIX = 'mailto:emcdonald@tumbybay.sa.gov.au?subject='
