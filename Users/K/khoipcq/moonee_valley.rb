...
STARTING_URL = 'https://online.mvcc.vic.gov.au/ePathway/Production/Web/GeneralEnquiry/EnquiryLists.aspx'
...
COMMENT_URL_PREFIX = 'mailto:mvccstat@mvcc.vic.gov.au?subject='
...
radio_value = page.form.radiobutton_with(:value => "ctl00$MainBodyContent$mDataList$ctl00$mDataGrid$ctl04$ctl00").check
