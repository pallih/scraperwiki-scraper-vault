...
<head>
    ...
    function buildMarker(data){
        ...
        var html = "<a href='"+data[4]+"'>"+data[2]+"</a><br /> ("+data[3]+")";
...
<h1 style="margin-top: 10px; ">Birmingham Swimming Pools</h1>
<div id="mapdiv" style="width:95%;height:550px;margin:10px auto;border: 2px #81A594 solid; background: #FFFFFF;"></div>
<p>Based on data from this <a href="http://www.birmingham.gov.uk/cs/Satellite?c=Page&childpagename=SystemAdmin%2FCFPageLayout&cid=1223349263026&packedargs=website%3D4&pagename=BCC%2FCommon%2FWrapper%2FCFWrapper" style="color: #81A594;">Birmingham City Council page on swimming pools</a>, using this <a href="https://scraperwiki.com/scrapers/birmingham_swimming_pools/" style="color: #81A594;">ScraperWiki scraper</a>.</p>
</body>
</html>
