...
QUERY = 'I need designated driver'
...
for page in range(1, NUM_PAGES+1):
    base_url = 'http://search.twitter.com/search.json?q=exclude:retweets+%s&rpp=%s&lang=%s&page=%scountry_code=US' \
    ...
    try:
        ...
        for result in results_json['results']:
            ...
            print data['from_user'], data['text'], data['geo'], data['created_at']
