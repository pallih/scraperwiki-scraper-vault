...
QUERY = '"I did not vote" -"EMA" -"AMA" -"obama" -"@barackobama" -"#barackobama" -"romney" -"@mittromney" -"#mittromney" -"xfactor" -"x-factor" -"x factor" -"district3" -"@district3" -"#district3" -"#xfactor"-"MTV" -"singer"'
