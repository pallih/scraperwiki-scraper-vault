...
@agent.set_proxy("111.161.30.227", 80)

page = @agent.post("http://www.easy.co.il/%D7%97%D7%A0%D7%95%D7%99%D7%95%D7%AA-%D7%91%D7%92%D7%93%D7%99%D7%9D/", {:foo => 'bar'}, headers)
p page

@index = 1
@url = "http://www.easy.co.il"

# get all categories
page.search('.subcatItemHuge a').each do|item|
  link = @url + item[:href].to_s
