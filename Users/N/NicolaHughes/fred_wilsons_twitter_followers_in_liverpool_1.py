...
for follower_list in group(followers_json, 100):
    ...
    for detail in details_json:
        foler = detail['followers']
        foling = detail['following']
        if (foler and FOLLOWERS.lower() in foler.lower()) or (foling and FOLLOWING.lower() in foling.lower()):
            data = {'screen_name': detail['screen_name'],'id': detail['id'],'followers': detail['followers'],'following': detail['following']}
