...
urllib.urlencode({'format': 'csv',
   ...
   'data-filename': 'cabinetspend.csv'})).read()
...
for line in doc:
    ...
    scraperwiki.sqlite.save(unique_keys=['URL','Transaction Number','Expense Type'],data=record, table_name="Refined")import scraperwiki
import urllib
import csv
import lxml.html
import urllib2
