#I've copied this in order to use the basic idea. Will rename before running. Thanks!
...
scrapeSpeeches()#I've copied this in order to use the basic idea. Will rename before running. Thanks!
