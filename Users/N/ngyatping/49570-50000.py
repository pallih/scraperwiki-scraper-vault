...
for n in range(49580,50000):
    ...
    data = { 'name' : name, 'district' : district, 'status' : status, 'address' : address, 'phone' : phone, 'type1' : type1, 'type2' : type2, 'type3' : type3, 'type4' : type4, 'type5' : type5, 'type6' : type6, 'type7' : type7, 'type8' : type8, 'type9' : type9, 'type10' : type10, 'price' : price, 'like' : like, 'normal' : normal, 'dislike' : dislike} 
