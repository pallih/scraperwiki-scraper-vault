...
def scrape_and_look_for_next_link(soup):
    scrape_table(soup)
    next_link = soup.find("javascript:return WebForm_OnSubmit();", { "id" : "aspnetForm" })
    if next_link:
        ...
        br['__EVENTTARGET'] = 'javascript:return WebForm_OnSubmit();'
        br['__EVENTARGUMENT'] = ''
        br.submit()
...
base_url = 'http://www.adx.ae/English/Market/Pages/' 
starting_url = base_url + 'Ownership.aspx'
