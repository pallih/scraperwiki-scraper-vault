...
print scraperwiki.sqlite.select('name, species, `attach-example-people`.swdata.first_name, `attach-example-people`.swdata.last_name from swdata left join `attach-example-people`.swdata on `attach-example-people`.swdata.id=swdata.owner')import scraperwiki
