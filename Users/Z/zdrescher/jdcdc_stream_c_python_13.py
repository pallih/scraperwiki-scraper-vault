...
page = urlopen("http://www.hockeydb.com/ihdb/stats/display_players.php?tmi=8871") #This line defines your webpage of interest
...
column_names = [td.text_content().replace('.','') for td in header_row.cssselect('th,td')] #this saves those column names as a variable we can reference later
...
for tr in table.cssselect('tr')[1:]: #This selects a specific row from the second row onwards
    ...
    data = dict(zip(column_names, cellvalues)) #this saves the data in our set
