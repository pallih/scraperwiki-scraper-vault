...
scraperwiki.sqlite.attach('desktops-fk-product-specs',"urls")
...
for url in urls:
 ...
 match_specs_variant = re.search(r'(specs-key">Processor Model[\W]+.{0,100})([\W]+)(.{0,100}">)([\(\)\w\s\d-]+)(</td>)',lines)
 ...
 match_specs_clockspeed = re.search(r'(specs-key">Processor Frequency[\W]+.{0,100})([\W]+)(.{0,100}">)([.\(\)\w\s\d-]+)(</td>)',lines)
 ...
 match_specs_hd = re.search(r'(specs-key">Hard Drive[\W]+.{0,100})([\W]+)(.{0,100}">)([.\(\)\w\s\d-]+)(</td>)',lines)
 if match_specs_hd:
 ...
 if match_specs_os:
  ...
  match_image_url = re.search(r'(http://[\w\d]+.flixcart.com/)(image/allinone-desktop[-/\w\d]+..{3,4})',lines)
  if match_image_url:
   image_url = match_image_url.group()
   image_path = "images/fk/"+match_image_url.group(2)

  match_screen = re.search(r'(specs-key">Display Size[\W]+.{0,100})([\W]+)(.{0,100}">)([.\(\)\w\s\d-]+)(</td>)',lines)
  if match_screen:
