...
def data_prep(content, country):#function to grab urls
    ...
    for num in range(1,25):
        ...
        xpath_string_site = '//*[@id="topsites-countries"]/div/ul/li[%d]/div[2]/h2/a'  % (num)
        xpath_string_url = '//*[@id="topsites-countries"]/div/ul/li[%d]/div[2]/span[@class="small topsites-label"]'  % (num)
#        print doc.xpath(xpath_string_site)[0].text
#        records += [(doc.xpath(xpath_string_rank)[0].text, doc.xpath(xpath_string_url)[0].text)]
        records += [(doc.xpath(xpath_string_url)[0].text, doc.xpath(xpath_string_rank)[0].text, doc.xpath(xpath_string_site)[0].text)]
