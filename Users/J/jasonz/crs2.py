...
# retrieve a page
starting_url = 'http://www.crs.com/Find_A_CRS?state=CO&country=US&rpp=2000&sort_by=last&with_photos=yup&state=CO&rppfirst=350&rpplast=450&state=CO&country=US&rpp=2000&sort_by=last&with_photos=yup&state=CO&rppfirst=200&rpplast=501&Next=Next+2000'
