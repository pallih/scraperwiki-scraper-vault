...
scraperwiki.sqlite.attach("movie_listings_spain")
movie_listing = scraperwiki.sqlite.select("* from movie_listings_spain.swdata order by movie_release_date desc")
...
scraperwiki.sqlite.save_var('movie_counter', movie_counter)    # -*- coding: utf8 -*-
import scraperwiki
import lxml.html
import json
import urllib
