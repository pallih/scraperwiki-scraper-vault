...
table = doc.xpath("//div[@class='noprint res']/div") #kokode syutokusita data ni kaigyou ga hairanai!!!

  table.xpath('//*').each do |ta|

name = ta.search("//span[@class='pp-place-title']/a/span").text
address= ta.search("//span[@class='pp-headline-item pp-headline-address']/span").text
