...
query="http://www.indeed.ca/jobs?q="+queries[j]+"&l="
queryurl="http://www.webproxy.ca/browse.php?u="+query+"&b=28&f=norefer"
#puts queryurl
#  doc = Nokogiri::HTML(open(queryurl))
agent = Mechanize.new
#agent.set_proxy "125.253.101.37", 8080
cookie = Mechanize::Cookie.new(   
   "domain"=>"www.webproxy.ca",
    "hostOnly"=> true,
    "httpOnly"=> false,
    "name"=> "s",
    "path"=> "/",
    ...
    "session"=> true,
    "storeId"=> "0",
    "value"=> "qofrjfjbufuo7824g9ks3rd2g3")

cookie.domain = "www.webproxy.ca"
cookie.path = "/"
page = agent.get("http://www.webproxy.ca")
