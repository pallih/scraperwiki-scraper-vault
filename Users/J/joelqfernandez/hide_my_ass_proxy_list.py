...
class HideMyAssSpider(CrawlSpider):
    ...
    'http://hidemyass.com/proxy-list/search-226543']
    ...
    def parseItem(self, response):
        ...
        for link in links:
            ...
            ipaddress = link.select('/html/body/div/div/table/tbody/tr/td[2]')
            ...
            loader.add_value('ipaddress', '/html/body/div/div/table/tbody/tr/td[2]')
