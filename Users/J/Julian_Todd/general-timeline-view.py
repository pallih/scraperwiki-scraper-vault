...
def DataCategory(data):
    if data.get("INTENT") == "D":
        cat = "Development"
    elif data.get("INTENT") == "E":
        cat = "Exploration"
    elif data.get("INTENT") == "A":
        cat = "Appraisal"
    else:
        cat = None
    d = data.get("date")
...
categories = ["Development", "Exploration", "Appraisal"]
...
<h2 id="message">UK Land oil wells drilled per year</h2>
