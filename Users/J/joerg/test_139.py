...
#init
baseURL      = "https://www.odesk.com/o/profiles/browse/?page="
maxPages     = 500 # 500 is oDesks maximum
listOfSkills = []
idCounter    = 0
...
for pageNumber in range(maxPages):
    ...
    for item in root.cssselect("li.oSearchResultItem"):
        for skill in item.cssselect("a.oSkill"):
