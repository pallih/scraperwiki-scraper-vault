...
# Blank Python
# Scraper for Wood Buffalo, AB Council 
...
COUNCIL_URL = 'http://www.woodbuffalo.ab.ca/Municipal-Government/Mayor-and-Council/Councillor-Profiles.htm'
...
def main():
    ...
    #for child in root[1]:
    print(root.xpath("//*[text()[contains(.,'Sonny')]]"))[0].getparent().tag

    return 
    for table in root.cssselect("h2"):
    ...
    mayor['district_name'] = 'Wood Buffalo'
    mayor['district_id'] = 0
