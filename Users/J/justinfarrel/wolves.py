...
QUERY = 'yellowstone+wolf+OR+gray+wolf+OR+endangered+wolf+OR+endangered+wolves+OR+grey wolf+OR+canadian+gray+wolf+OR+idaho+wolf+OR+idaho+wolves+OR+montana+wolf+OR+montana+wolves+OR+wyoming+wolf+OR+wyoming+wolves'
