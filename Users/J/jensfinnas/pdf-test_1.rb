...
# smaller pdf
 pdf = open('http://www.iaaf.org/mm/Document/Competitions/Competition/05/15/63/20090706014834_httppostedfile_p345-688_11303.pdf')
...
receiver.content.each {|r| ScraperWiki.save(['data'], {'data' => r.strip})}
#doc.search('td').each do |td|
#    ScraperWiki.save(['data'], {'data' => r.strip})
#end
