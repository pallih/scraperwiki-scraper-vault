...
tweets.each do |tweet|
  ...
  tweet_content = Sanitize.clean(tweet.search('.js-tweet-text')[0].inner_html.strip, :elements => ['a'], :attributes => {'a' => ['href']}).gsub("href=\"/", "href=\"https://www.twitter.com/")

  if source.downcase != username.downcase
    # This is a retweet
    details[:tweet] = "RT <a href=\"https://twitter.com/#{source}\">@#{source}</a> " + tweet_content
  else
