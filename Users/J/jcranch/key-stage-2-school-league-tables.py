"""
DCSF School league tables: Key stage 2 (Primary schools)

http://www.education.gov.uk/performancetables/primary_09.shtml

The following document explains some of the codes:

http://www.education.gov.uk/performancetables/primary_09/glossary.shtml
"""
...
def get_lea_list():
    ...
    url = "http://www.education.gov.uk/performancetables/primary_09.shtml"
    page = urlopen(url)
...
def obtain_lea_number(lea_name):
    ...
    url = "http://www.education.gov.uk/cgi-bin/performancetables/search_09.pl?Fieldname=&Fieldpostcode=&FieldLEA=%s&Mode=Z&Phase=p&Year=09&Base=p&Begin=s"%"+".join(lea_name.split(" "))
...
def scrape_lea(name, number):
    ...
    url = "http://www.education.gov.uk/cgi-bin/performancetables/group_09.pl?Mode=Z&No=%d&Base=p&Type=LA&Begin=s&Phase=p&Year=09&F=1&L=10000"%number
    page = html.parse(url)
