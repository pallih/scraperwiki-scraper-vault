...
property_url = "http://ikman.lk/en/cars-vehicles-in-sri-lanka?page="
...
for i in property_length:
    ...
    for table in root.cssselect("li.item"):
        ...
        if (not geocode_disabled):
            scraperwiki.sqlite.save(unique_keys=["header"],data={"id":idx,"header":adHeader,"location": location, "content_url":content_url,"source":"IKM", "type":ad_type,"thumbnail_url":thumbnail_url, "lat":data_lat, "lon": data_lng, "price_in_lkr":priceInLKR, "added_date": added_date })
        else:
            scraperwiki.sqlite.save(unique_keys=["header"],data={"id":idx,"header":adHeader,"location": location, "content_url":content_url,"source":"IKM", "type":ad_type,"thumbnail_url":thumbnail_url, "price_in_lkr":priceInLKR, "added_date": added_date})
