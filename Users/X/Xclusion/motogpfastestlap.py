...
url=    [['http://www.motogp.com/en/Results+Statistics/2013/QAT/MotoGP', 'Losail', '2013'],
...
for entry in url:
    ...
    #print(lap)
    print(track,season,rider,lap,time,speed)
    #scraperwiki.sqlite.save(unique_keys=["circuit", "season"], data={"circuit":track, "season":season,"lap":lap, "rider":rider, "time":time,"speed":speed})
