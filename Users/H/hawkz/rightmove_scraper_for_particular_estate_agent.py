...
exchanges = {
    'Norwich City':   ('NR24AE','POSTCODE%5E608365'),
    'Norwich North':  ('NR66TY','POSTCODE%5E615149'),
    'Norwich West':   ('NR47QG','POSTCODE%5E614589'),
    'Thorpe':         ('NR70QF','POSTCODE%5E615367'),
    'Salhouse':       ('NR136PE','POSTCODE%5E606087'),
    'Surlingham':     ('NR147DE','POSTCODE%5E1717106'),
    'Brundall':       ('NR135PB','POSTCODE%5E1550246'),
    'South Walsham':  ('NR136AH','POSTCODE%5E605998'),
    'Acle':           ('NR133BU','POSTCODE%5E1366403'),
    'Potter Heigham': ('NR295HZ','POSTCODE%5E610902'),
    'Saint Benets':   ('NR295QF','POSTCODE%5E1551429'),
    'Wroxham':        ('NR128UG','POSTCODE%5E605440'),
    'Fleggburgh':     ('NR293AF','POSTCODE%5E1551341'),
    'Ormesby':        ('NR293RJ','POSTCODE%5E1551368'),
    'Caister-on-Sea': ('NR305AQ','POSTCODE%5E611834'),
    'Great Yarmouth': ('NR301PN','POSTCODE%5E611528'),
    'Gorleston':      ('NR317BE','POSTCODE%5E612205'),
    'Burgh Castle':   ('NR319PT','POSTCODE%5E1551773'),
    'Freethorpe':     ('NR133LZ','POSTCODE%5E605671'),
    'Fritton':        ('NR319HP','POSTCODE%5E1367211'),
}

for exc, pcode in exchanges.iteritems():
    url = '/property-to-rent/find.html?locationIdentifier=' + pcode[1] + '&maxPrice=700&minBedrooms=2&radius=1.0'
