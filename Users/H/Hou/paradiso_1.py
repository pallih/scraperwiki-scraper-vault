...
starting_url  = urlparse.urljoin(base_url,'http://paradiso.nl/web/Agenda-Item/DOOM-5-DAYS-OFF-DAY2.htm') #'web/Agenda-Item/Chris-Smither-Peter-Mulvey.htm')
#'web/Agenda-Item/Arbouretum-1.htm'
get_pardiso_events(starting_url)
record.append('web/Agenda-Item/Arbouretum-1.htm')
 ###########################################
 ####################################
  # Scrapper Paradiso.nl  
