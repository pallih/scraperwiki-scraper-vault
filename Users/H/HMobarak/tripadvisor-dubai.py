...
def parse_list(root):
    ...
    for el in root(".listing a.property_title"):
        ...
        scraperwiki.sqlite.save(unique_keys=['source_url'], data=data, table_name="tripadvisor_dubai")
...
start_url = "http://www.tripadvisor.com/Hotels-g295424-Dubai_Emirate_of_Dubai-Hotels.html"
