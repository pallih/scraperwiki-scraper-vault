#http://vimeo.com/18787139 
#http://shrib.com/hamzuz
 ...
 # open the required libraries
  ...
  list_of_profiles_page = Nokogiri::HTML(open('http://xfree.co.il/Memebers_Profiles_26.04.2013.htm', 'User-Agent' => 'ruby'))
