...
STARTING_URL = 'https://epathway.wtcc.sa.gov.au/ePathway/Production/Web/default.aspx?js=-1515084499'
...
page = @agent.get('ePathway/Production/Web/GeneralEnquiry/EnquirySearch.aspx?ctl00$MainBodyContent$mGeneralEnquirySearchControl$mTabControl$ti=2')
p page

#button = page.forms.first.button_with(:name=>'ctl00$MainBodyContent$mGeneralEnquirySearchControl$mSearchButton')
#p page.forms.first.click_button(button)
