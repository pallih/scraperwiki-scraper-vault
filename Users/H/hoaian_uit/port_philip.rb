...
STARTING_URL = 'https://eservices.portphillip.vic.gov.au/ePathway/Production/Web/'
...
page = @agent.get('https://eservices.portphillip.vic.gov.au/ePathway/Production/Web/GeneralEnquiry/EnquirySearch.aspx')
p page

#radiobutton = page.forms.first.radiobutton_with(:id=>'ctl00_MainBodyContent_mDataList_ctl00_mDataGrid_ctl03_ctl00').check
