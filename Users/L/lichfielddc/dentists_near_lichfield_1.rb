...
url = BASE_URL + "/Service-Search/Dentists/ws13-6yy/Results/12/-1.82836246490479/52.6803779602051/3/0?distance=25&ResultsOnPageValue=100"
...
services.each do |service|
  ...
  contact = doc.search("td[@headers='#{service[:id]} addressandcontactdetails']")
