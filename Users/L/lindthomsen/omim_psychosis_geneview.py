...
for i in range(100):# 100 is used as an absolut maximum, there is a break 
    #change the search criteria to make other searches
    html = scraperwiki.scrape("http://omim.org/search?index=clinicalSynopsis&start="+str(i)+"&limit=100&search=psychosis+or+psychoses&sort=score+desc")
    i=0;
