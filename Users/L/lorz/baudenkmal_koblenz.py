...
category = "Bauwerk in Koblenz"

urlCategory = "http://de.wikipedia.org/w/api.php?action=query&list=categorymembers&cmtitle=Kategorie:Bauwerk_in_Koblenz&cmlimit=500&format=json"
