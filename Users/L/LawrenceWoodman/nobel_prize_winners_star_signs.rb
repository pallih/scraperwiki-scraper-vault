...
% end
        ...
        var options = {'title':'Star Signs of Nobel Prize Winners',
                       'width':700,
                       'height':500};
    ...
    <h2>The Distribution of Star Signs Among Nobel Prize Winners</h2>
...
data = ScraperWiki.select(           
  "star_sign from nobel_prize_winners_dob.swdata"
)
