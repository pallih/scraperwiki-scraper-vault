require 'date'
require 'erb'
sourcescraper = 'https://scraperwiki.com/scrapers/comedians_dob/'
...
% end
        ...
        var options = {'title':'Months of Birth for Comedians',
                       'width':700,
                       'height':500};
    ...
    <h2>The Distribution of Months of Birth Among Comedians</h2>

    <div>
      This was obtained by scraping wikipedia&#039;s List of 
      <a href='http://en.wikipedia.org/wiki/List_of_comedians'>comedians</a>.
...
ScraperWiki.attach("comedians_dob") 

data = ScraperWiki.select(           
  "dob from comedians_dob.swdata"
)
