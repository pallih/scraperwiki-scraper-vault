require 'date'
require 'erb'
sourcescraper = 'https://scraperwiki.com/scrapers/biologists_chemists_and_physicists_dob/'
...
% end
        ...
        var options = {'title':'Months of Birth for Biologists, Chemists and Physicists',
                       'width':700,
                       'height':500};
    ...
    <h2>The Distribution of Months of Birth Among Biologists, Chemists and Physicists</h2>

    <div>
      This was obtained by scraping wikipedia&#039;s List of 
      <a href='http://en.wikipedia.org/wiki/List_of_biologists'>biologists</a>,
      <a href='http://en.wikipedia.org/wiki/List_of_chemists'>chemists</a> and
      <a href='http://en.wikipedia.org/wiki/List_of_physicists'>physicists</a>.
...
ScraperWiki.attach("biologists_chemists_and_physicists_dob") 

data = ScraperWiki.select(           
  "dob from biologists_chemists_and_physicists_dob.swdata"
)
