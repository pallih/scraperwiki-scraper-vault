require 'date'
require 'erb'
sourcescraper = 'nobel_prize_winners_dob'
...
% end
        ...
        var options = {'title':'Months of Birth for Nobel Prize Winners',
                       'width':700,
                       'height':500};
    ...
    <h2>The Distribution of Months of Birth Among Nobel Prize Winners</h2>

    <div>
      This was obtained by scraping wikipedia&#039;s 
      <a href='http://en.wikipedia.org/wiki/List_of_nobel_prize_winners'>List of Nobel Prize Winners</a>,
      and then scraping the page for each person to see when they were born.
    </div>
    ...
    <table>
      <tr>
        <th style='text-align: left; padding-right: 1em;'>Month of Birth</th>
...
ScraperWiki.attach("nobel_prize_winners_dob") 

data = ScraperWiki.select(           
  "dob from nobel_prize_winners_dob.swdata"
)
