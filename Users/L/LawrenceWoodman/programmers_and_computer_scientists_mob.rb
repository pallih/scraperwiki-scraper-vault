...
% end
        ...
        var options = {'title':'Months of Birth for Programmers and Computer Scientists',
                       'width':700,
                       'height':500};
    ...
    <h2>The Distribution of Months of Birth Among Notable Programmers and Computer Scientists</h2>
...
data = ScraperWiki.select(           
  "dob from programmers_and_computer_scientists_dob_1.swdata"
)
