...
% end
        ...
        var options = {'title':'Star Signs of Biologists, Chemists and Physicists',
                       'width':700,
                       'height':500};
    ...
    <h2>The Distribution of Star Signs Among Biologists, Chemists and Physicists</h2>
...
data = ScraperWiki.select(           
  "star_sign from biologists_chemists_and_physicists_dob.swdata"
)
