require 'date'
require 'erb'
sourcescraper = 'https://scraperwiki.com/scrapers/programmers_and_computer_scientists_dob_1/'
...
% end
        ...
        var options = {'title':'Star Signs of Programmers and Computer Scientists',
                       'width':700,
                       'height':500};
    ...
    <h2>The Distribution of Star Signs Among Notable Programmers and Computer Scientists</h2>

    <div>
      This was obtained by scraping wikipedia&#039;s 
      <a href='http://en.wikipedia.org/wiki/List_of_programmers'>List of programmers</a> and
      <a href='http://en.wikipedia.org/wiki/List_of_computer_scientists'>List of computer scientists</a>.
...
ScraperWiki.attach("programmers_and_computer_scientists_dob_1") 

data = ScraperWiki.select(           
  "star_sign from programmers_and_computer_scientists_dob_1.swdata"
)
...
puts ERB.new(PAGE_TEMPLATE, 0, '%').result(binding)require 'date'
require 'erb'
sourcescraper = 'https://scraperwiki.com/scrapers/programmers_and_computer_scientists_dob_1/'
