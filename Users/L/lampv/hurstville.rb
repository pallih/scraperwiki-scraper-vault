...
STARTING_URL = 'http://onlineservices.hurstville.nsw.gov.au/MasterViewLive/modules/applicationmaster/default.aspx'
...
COMMENT_URL_PREFIX = 'mailto:hccmail@hurstville.nsw.gov.au?subject='
