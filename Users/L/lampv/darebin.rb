...
STARTING_URL = 'https://eservices.darebin.vic.gov.au/ePathway/Production/Web/GeneralEnquiry/EnquiryLists.aspx'
...
def get_da_summary(page, da_container)
  ...
  record = {
    ...
    'date_received' => Date.strptime(clean_whitespace(tds[4].at('span').text), '%d/%m/%Y').to_s,
    'address' => clean_whitespace(tds[2].at('div').text),
    'description' => CGI::unescapeHTML(clean_whitespace(tds[3].at('div').text)),
...
first_page_form['__EVENTTARGET'] = 'ctl00$MainBodyContent$mGeneralEnquirySearchControl$mTabControl$tabControlMenu'
first_page_form['__EVENTARGUMENT'] = '1'



page = first_page_form.submit(first_page_form.button_with(:value => "Search"))
