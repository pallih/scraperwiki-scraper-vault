...
STARTING_URL = 'http://www.tweed.nsw.gov.au/modules/applicationmaster/default.aspx?page=found&1=01/07/2009&2=05/01/2013&3=&4=DA&4a=DA&6=F&11=&12=&13=&14=&21=&22='
...
COMMENT_URL_PREFIX = 'mailto:tsc@tweed.nsw.gov.au?subject='
...
page = page.forms.first.submit(page.forms.first.button_with(:value => "I Accept"))
page = page.forms.first.submit(page.forms.first.button_with(:id => "ctl00_PH_Main_ctl00_btnSearch"))
page = agent.get(STARTING_URL)
