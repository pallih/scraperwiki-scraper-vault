...
STARTING_URL = 'https://services.melvillecity.com.au/ePathway/Production/Web/GeneralEnquiry/EnquiryLists.aspx'
...
page = page.forms.first.submit(page.forms.first.button_with(:value => "Next"))
