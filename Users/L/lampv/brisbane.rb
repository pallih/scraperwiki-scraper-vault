...
STARTING_URL = 'http://pdonline.brisbane.qld.gov.au/masterview/modules/applicationmaster/default.aspx?page=search'
...
page = page.forms.first.click_button(page.forms.first.button_with(:id => "_ctl4_btnOk"))
...
while (Date.parse(from_date.strftime('%d/%m/%Y').to_s) >= Date.parse('01/01/1997')) do
  ...
  page_form_search.field_with(:id => "_ctl2_drDates_txtDay2").value = to_date.day.to_s
  page_form_search.field_with(:id => "_ctl2_drDates_txtMonth2").value = to_date.month.to_s
  page_form_search.field_with(:id => "_ctl2_drDates_txtYear2").value = to_date.year.to_s
