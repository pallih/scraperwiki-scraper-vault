...
##
#Class::FraserCoastScraper
#
class FraserCoastScraper < InfoMasterScraper
  def applications(date)
    base_path = "http://pdonline.frasercoast.qld.gov.au/Modules/applicationmaster/"
...
new_scraper = FraserCoastScraper.new("Fraser Coast Regional Council", "Fraser Coast", "QLD")
new_scraper.applications(Date.new())require 'rubygems'
require 'mechanize'
require 'nokogiri'
require 'enumerator'
require 'date'
...
new_scraper = FraserCoastScraper.new("Fraser Coast Regional Council", "Fraser Coast", "QLD")
new_scraper.applications(Date.new())