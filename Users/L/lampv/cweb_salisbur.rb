...
STARTING_URL = 'https://cweb.salisbury.sa.gov.au/ePathway/Production/Web/GeneralEnquiry/EnquiryLists.aspx'
...
# Email mailto links are also valid in this field.
  ...
  COMMENT_URL_PREFIX = 'mailto:customercentre@salisbury.sa.gov.au?subject='
...
def get_da_summary(page, da_container)
  ...
  record = {
    ...
    'date_received' => Date.strptime(clean_whitespace(tds[5].at('span').text), '%d/%m/%Y').to_s,
