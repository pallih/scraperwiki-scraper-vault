  ...
  def applications(date)
    ...
    table.map do |values|
      da = DevelopmentApplication.new(
        ...
        :date_received => extract_date_received(values[3]))
...
new_scraper = BrisbaneScraper.new("Brisbane City Council", "Brisbane", "QLD")
new_scraper.applications(Date.new(2012,3,4))require 'rubygems'
require 'mechanize'
require 'nokogiri'
require 'enumerator'
require 'date'
