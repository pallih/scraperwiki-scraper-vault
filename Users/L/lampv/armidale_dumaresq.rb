...
def get_da_summary(page, da_container)
  ...
  record = {
    ...
    'address' => clean_whitespace(tds[1].at('div').text),
    'description' => CGI::unescapeHTML(clean_whitespace(tds[2].at('div').text)),
...
second_page_form.add_field!('__EVENTARGUMENT','1')
second_page_form.field_with(:name => /SearchTabStrip_State/).value = "1"
 
#second_page_address_search_tab = @agent.submit(second_page_form)
