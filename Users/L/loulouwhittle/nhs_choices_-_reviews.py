...
html = scraperwiki.scrape("http://www.nhs.uk/Services/hospitals/ReviewsAndRatings/DefaultView.aspx?id=793")
root = lxml.html.fromstring(html)
#print root

divs = root.cssselect('div.comments div') #select all of the tr elements
