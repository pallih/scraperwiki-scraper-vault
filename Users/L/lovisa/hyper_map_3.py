...
def scrape_people(role='student' or 'coworker' or 'collaborator' or 'alumni' ):
...
def geocode_nationalities(role='student' or 'coworker' or 'collaborator' or 'alumni'):
    import json
...
scrape_people('student' or 'coworker' or 'collaborator' or 'alumni')
geocode_nationalities('student' or 'coworker' or 'collaborator' or 'alumni')import scraperwiki
import requests
import lxml.html
...
scrape_people('student' or 'coworker' or 'collaborator' or 'alumni')
geocode_nationalities('student' or 'coworker' or 'collaborator' or 'alumni')