...
if( $data['error']['message'] == "No data. There are no results to show." ) { $iditen++; }
if( $data['error']['message'] == "No Error" ) { $iditen--; }
...
#scraperwiki::save_sqlite(array('id','title'),$values,$table);
scraperwiki::sqlitecommit();
#}
?><?php
#Add API to retrieve incident with comments
