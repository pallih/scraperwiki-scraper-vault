...
ScraperWiki.sqliteexecute("CREATE TABLE IF NOT EXISTS EVENTS(ID INTEGER PRIMARY KEY AUTOINCREMENT,DAY TEXT,TIME_PLACE TEXT,DETAILS TEXT);")
...
engt = get_metadata("ENGAGEMENT",200910)
