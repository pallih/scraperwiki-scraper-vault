...
url= "https://api.scraperwiki.com/api/1.0/datastore/sqlite?format=htmltable&name=peru_provinces&query=select%20*%20from%20%60swdata%60%20limit%20100000"
            ...
            if i==13 then #Poblacion
              ...
              if i==7 then# electores varones
                ...
                if i==17 then# superficie
                  ...
                  if i==11 then #electores mujeres
                    puts datos.inner_html
