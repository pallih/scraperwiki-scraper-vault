...
# Ruby script to collect information from concerts in bachtrack.com
# It uses another script that has firstly gathered all the urls where the
...
# Getting list of concerts from the initial script
url= "https://api.scraperwiki.com/api/1.0/datastore/sqlite?format=htmltable&name=conciertos&query=select%20*%20from%20%60swdata%60%20limit%20100000"
html= ScraperWiki.scrape(url)
