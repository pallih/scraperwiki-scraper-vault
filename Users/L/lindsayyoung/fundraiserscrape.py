...
def process_results(result_list):
    for n in result_list:
        if string.find(n['url'],'barackobama.com') > -1:
            try:
...
searchUrl = 'http://ajax.googleapis.com/ajax/services/search/web?v=1.0&q="To%20attend,%20please%20RSVP%20using%20the%20form%20to%20the%20right"'
