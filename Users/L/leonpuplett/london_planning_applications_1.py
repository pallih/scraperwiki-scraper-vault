...
REGION = 'London'
DB_START = 63 # default date (in YYYY-MM-DD format) to scrape from (or a number if you want it to start x days ago)
DB_END = 7 # default date (in YYYY-MM-DD format) to scrape to (or a number if you want it to stop x days ago)
...
update_authorities()
auth_list = util.get_auths(['Newham Borough Council']) # NB simple string is a region, list is a list of authorities
for auth in auth_list:
    util.gather_applications(auth, DB_START, DB_END, 1, 240)
