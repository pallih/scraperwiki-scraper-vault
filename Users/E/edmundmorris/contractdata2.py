...
scraperwiki.sqlite.attach("contractfinder2") # Attaching scraper https://scraperwiki.com/scrapers/dfid-contracts/

links = scraperwiki.sqlite.select("URL from `contractfinder2`.swdata") # Selecting the URLs collected from the search results from contract finder
