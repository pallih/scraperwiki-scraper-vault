...
scraperwiki.sqlite.attach("contractfinder") # Attaching scraper https://scraperwiki.com/scrapers/dfid-contracts/

links = scraperwiki.sqlite.select("URL from `contractfinder`.swdata") # Selecting the URLs collected from the search results from contract finder
