...
html = scraperwiki.scrape("http://fr.wikipedia.org/w/api.php?format=json&action=query&titles=Effondrement_d'un_immeuble_à_Savar_en_2013&prop=revisions&rvprop=content")
