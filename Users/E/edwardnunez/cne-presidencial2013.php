...
$html_URL = "http://www.cne.gob.ve/resultado_presidencial_2013/r/1/reg_000000.html";
...
$saved_counter = 0;
$lastrun_counter = scraperwiki::get_var('LastRunCounter', 0);

foreach($dom->find("tr.tbsubtotalrow") as $data){ 
...
$SVestado_counter = scraperwiki::get_var('EstadoCounter', 0);
$SVmunicipio_counter = scraperwiki::get_var('MunicipioCounter', 0);
$SVparroquia_counter = scraperwiki::get_var('ParroquiaCounter', 0);
$SVcentro_counter = scraperwiki::get_var('CentroCounter', 0);
$SVmesa_counter = scraperwiki::get_var('MesaCounter', 0);
...
foreach($dom->find("li.region-nav-item a#region_ref") as $estado_data) {

  $municipio_counter = 0;

  if ($estado_counter >= $SVestado_counter) {

    $html_URL = "http://www.cne.gob.ve/resultado_presidencial_2013" . preg_replace('/\.\.\/\.\./', '', $estado_data->href);
