...
filters=["d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z"]
...
for letter in filters:
    ...
    html=scraperwiki.scrape(site + "/directory/listings.aspx?cat_id=133&country_id=1&state_id=-1&filter=" + letter)
            ...
            if listingblocks.cssselect(".basichdr"):
                ...
                for listing in listingblocks.cssselect("h3 a"):
                    ...
                    if not linebreak<0:
                        ...
                        equalpos = url2.find("=")
                        uniquekey= url2[equalpos+1:len(url2)]
                        #Data is saved.
                        scraperwiki.sqlite.save(unique_keys=["Listing number"], data={"Listing number":uniquekey, "Number":count, "Production Co":name, "Address line 1":line1, "Address line 2":line2, "City":city, "State":state, "Zip":zip})
