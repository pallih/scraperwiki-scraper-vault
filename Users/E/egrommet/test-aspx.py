...
# scraperwiki.metadata.save('data_columns', ['Clinician', 'CurrentRecognitions', 'Location'])
...
#            if b != 'None':
            print b
#            record['Address'] = table_cells[1]('br')[0].text
#            record['City'] = table_cells[1]('br')[1].split(",")[0].text
