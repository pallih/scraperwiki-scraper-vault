            ...
            if dom is not None:
                ...
                for target in targetList:
                    ...
                    if dom2 is not None:
                        ...
                        print "(2) request to %s failed" % ad["url"]
                    # lets save this ad to our list of ads
                    ads.append(ad)
                    ad_count += 1
            else:
                print "(3) request to %s failed" % url
...
scrape_ads("microwave", subdomain_urls)import scraperwiki
...
# insert the query here try it out on the real website first, have fun
subdomain_urls = get_target_subdomains()
scrape_ads("microwave", subdomain_urls)