...
def get_target_domains():
    areas = {}
    r = requests.get('http://www.craigslist.org/about/sites/')
...
#    scraperwiki.sqlite.execute("INSERT INTO swdata ("query") VALUES ("electrolux");")# A scraper to collect words with a query *see bottom
