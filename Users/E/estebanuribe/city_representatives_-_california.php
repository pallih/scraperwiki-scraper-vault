<?php
#copied Philip Ashlock's scraper to explore and look around, don't rely on this one for accuracy/up-to-date-ness,  see https://scraperwiki.com/scrapers/city_representatives/ instead 
