...
$thevictim = "nothingbutass"; // replace with some victims username
$victimstrace = $thevictim . ".tumblr.com";
$howmanypages = 174; // replace with the actual number of pages you want it to search for and shoot in your face
