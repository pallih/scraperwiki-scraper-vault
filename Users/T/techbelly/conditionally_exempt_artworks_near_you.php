...
<h2><span id="scrapername">...</span> <em id="message"> near you</em></h2>
...
var sourcescraper = 'Conditionally Exempt Artworks.';
...
{
    return '<a href="http://www.visitukheritage.gov.uk/servlet/com.eds.ir.cto.servlet.CtoDetailServlet?ID='+record['unique_id']+'" target="_blank">'+record["description"]+'</a>';
}
...
function loaddata() 
{
    ...
    url = "http://api.scraperwiki.com/api/1.0/datastore/getdata?&format=json&name=conditionally_exempt_art_works&limit="+olength+"&callback=gotback&offset=" + offset;
