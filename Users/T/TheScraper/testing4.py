...
#<span class=" fk-font-big fk-bold final-price"> Rs. 35903</span>
 ...
 scraperwiki.sqlite.save(['url'],data={'id':count,'imgpath':title,'url':url,'title':title,'price':price,'shipping':shipping,'delivery':delivery,'stock':stock,'graphics':'','os':'','hd':'','ram':'','subtitle':'','brand':'','display':'','frequency':'','seller_type':'','seller_name':'Flipkart','no_sellers':'1','status':'0','insert_status':'0'})    import scraperwiki
