###############################################################################
# Scape planning applications to Bath and North East Somerset council
###############################################################################
...
SEARCH_FORM=u"http://isharemaps.bathnes.gov.uk/projects/bathnes/developmentcontrol/default.aspx"
...
class PlanningApp(dict):
    ...
    def latlng(self):
        ...
        if self[u'Address of Proposal']:
            return geo.gb_postcode_to_latlng(geo.extract_gb_postcode(self[u'Address of Proposal']))
        else:
            return None
