...
$thevictim = "sexismusimalltag"; // replace with some victims username
$victimstrace = $thevictim . ".tumblr.com";
$howmanypages = 3; // replace with the actual number of pages you want it to search for and shoot in your face
