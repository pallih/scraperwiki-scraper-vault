...
for tr in root.cssselect("div.entry-content tr"):
    ...
    print address
    filtered_address = filter(lambda c: c in string.digits + ',' + '.' + ' ' + "#" + string.letters, address)   
    print filtered_address + ", Seattle, WA"

    returned = us.geocode(filtered_address + ", Seattle, WA")
    if returned != None: 
