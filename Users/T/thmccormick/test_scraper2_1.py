...
QUERY = '"Im not voting" OR "Im not going to vote" OR "I wont vote" OR "no voy a votar" OR "no estoy votando" -AMC -"american idol" -"American idol" -EMA -prom -dwts -DWTS -"Dancing with the stars"'
