...
#        xpath_string_site = '//*[@id="topsites-countries"]/div/ul/li[%d]/class[topsite-label]'  % (num)
#        records += [(doc.xpath(xpath_string_rank)[0].text, doc.xpath(xpath_string_site)[2].text)]
