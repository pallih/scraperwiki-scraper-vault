# Commonwealth universities from Wikipedia
import scraperwiki
import lxml.html
import urllib2

categories = ['http://en.wikipedia.org/wiki/Category:Association_of_Commonwealth_Universities',]
...
for category_url in categories:
    ...
    while category_url_next is not None:
        ...
        for a in tree.xpath('//td/ul/li/a'):
            scraperwiki.sqlite.save(['url'], {'name': a.text, 'category_url': category_url, 'url': "http://en.wikipedia.org%s" % a.attrib['href']}, table_name='universities')
