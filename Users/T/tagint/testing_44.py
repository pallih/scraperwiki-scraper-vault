...
def get_feed(feed_url):
    ...
    for entry in entries:
        ...
        locations.append({'idfld':idfld,'title': entry["title"], 'identifier': entry["link"], 'modified': entry["updated"], 'abstract': entry["description"], 'latitude': entry["geo_lat"],'longitude': entry["geo_long"],'source': data["source"]})
