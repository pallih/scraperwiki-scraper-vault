...
for item in results:
    ...
    url1 = "https://api.foursquare.com/v2/venues/"+vid+"/herenow?oauth_token=CJRRXXXINNV5UU0WS4K3C510XTWQ3OACIKHOKOAS3BL5UJU1&v=20130318"
    resultsJson1 = simplejson.loads(scraperwiki.scrape(url1))
    results1 = resultsJson1['response']['hereNow']

    herenow = results1['count']
