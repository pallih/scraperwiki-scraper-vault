...
unzipped_text = open("http://dl.dropbox.com/u/1186808/census/2007gid_schools_esa.txt").read
...
schools.each do |school|
  data = {:file_id            => school[0..13].strip,
          ...
          :zip_code           => school[247..255].strip,
          :url                => school[256..354].strip,
          :number             => school[355..360].strip,
          :parent_body_name   => school[353..361].strip,
          :parent_body_type   => school[396..430].strip,
  }
  #puts data.to_json
