...
unzipped_text = open("http://dl.dropbox.com/u/1186808/census/2007gid_schools_localdep.txt").read
...
schools.each do |school|
  data = {:file_id            => school[0..13].strip,
          ...
          :number             => school[353..370].strip,
          :parent_body_name   => school[371..405].strip,
          :parent_body_type   => school[406..435].strip
  }
  #puts data.to_json
