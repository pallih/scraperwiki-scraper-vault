...
response1 = br.open(image_url)
#responseimage=b'\xc3\x84\xc3\xa8'
responseimage=response1.read()

imagedata= base64.b64encode(responseimage)
print imagedata
#responseimageutf8= responseimage.encode("utf-8") 

#imagedata=unicode( responseimageutf8   )
...
c = pycurl.Curl()
values = [
          ("key", "b0f99730dadd7533e738750fb1077688"),
...
scraperwiki.sqlite.save(unique_keys=["imageurl"],data={"siteurl":siteurl,"imageurl":image_url,"image_blob":imagedata,"lp_url":lp_url,"exourl":exo_url})
