...
//scraperwiki::sqliteexecute('CREATE TABLE `solat` (`Zone` text, `Tarikh` text, `Hari` text,`Imsak` text,`Subuh` text,  `Syuruk` text, `Zohor` text, `Asar` text, `Maghrib` text, `Isyak` text )');
