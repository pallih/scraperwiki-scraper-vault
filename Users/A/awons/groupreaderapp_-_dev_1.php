...
class GroupAppScraper
{
    ...
    const SOURCES_URL = 'http://webservice.sm.groupreaderapp.com/scraper/getSources'; // Update this when scraper is private
    const ERROR_REPORT_URL = 'http://webservice.sm.groupreaderapp.com/scraper/reportError'; // Update this when scraper is private
