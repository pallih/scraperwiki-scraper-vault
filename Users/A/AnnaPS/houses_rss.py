...
good_houses = scraperwiki.sqlite.select(           
    '''title,description,link,pubDate from rightmove.swdata 
    where stop is ''
    order by pubDate desc'''
)

print len(good_houses)
...
rss_text += """<channel>
<title>Good Houses - Anna + Tom's House Scraper</title>
...
for i, house_item in enumerate(good_houses):
