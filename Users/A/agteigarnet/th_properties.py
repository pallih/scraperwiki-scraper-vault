...
#<p id="listing-details-price" class="price fright neither">
#        &pound;373,948 <span>(&#xE3F;18,000,000)</span>
#</p>
...
url1 = '/overseas/property/thailand/?country_code=th&currency=gbp&include_shared_accommodation=true&new_homes=include&results_sort=newest_listings&search_source=overseas'
INITIAL_URL = url1
# download the search page
scrape_results_page(INITIAL_URL, "Thailand", initial=True)
