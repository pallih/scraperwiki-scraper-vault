...
category = "Baudenkmal in Hannover"

urlCategory = "http://de.wikipedia.org/w/api.php?action=query&list=categorymembers&cmtitle=Kategorie:Baudenkmal_in_Hannover&cmlimit=500&format=json"
