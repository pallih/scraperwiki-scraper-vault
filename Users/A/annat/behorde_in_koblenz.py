...
category = "Behörde in Koblenz"

urlCategory1 = "http://de.wikipedia.org/w/api.php?action=query&list=categorymembers&cmtitle=Category:Beh%C3%B6rde_in_Koblenz&cmlimit=500&format=json"
