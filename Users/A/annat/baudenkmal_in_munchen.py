...
coords = ["lat=48.1427&lng=11.5698"]
locationDict = {}
for j in range(1):
...
category = "Denkmalgeschütztes Ensemble in München"

urlCategory1 = "http://de.wikipedia.org/w/api.php?action=query&list=categorymembers&cmtitle=Category:Denkmalgesch%C3%BCtztes_Ensemble_in_M%C3%BCnchen&cmlimit=500&format=json"
