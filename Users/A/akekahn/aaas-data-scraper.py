...
url = "http://aaas.confex.com/aaas/2013/webprogram/SEMINAR.html"
dataId = scrape_from_root(url, dataId)

url = "http://aaas.confex.com/aaas/2013/webprogram/OPENING.html"
dataId = scrape_from_root(url, dataId)

url = "http://aaas.confex.com/aaas/2013/webprogram/PLENARY.html"
dataId = scrape_from_root(url, dataId)

url = "http://aaas.confex.com/aaas/2013/webprogram/SPECIAL.html"
dataId = scrape_from_root(url, dataId) 

url = "http://aaas.confex.com/aaas/2013/webprogram/TOPICAL.html"
dataId = scrape_from_root(url, dataId)

url = "http://aaas.confex.com/aaas/2013/webprogram/EVENTS.html"
dataId = scrape_from_root(url, dataId)

url = "http://aaas.confex.com/aaas/2013/webprogram/BUSINESS.html"
dataId = scrape_from_root(url, dataId)

url = "http://aaas.confex.com/aaas/2013/webprogram/WORK.html"
dataId = scrape_from_root(url, dataId)

url = "http://aaas.confex.com/aaas/2013/webprogram/LOUNGE.html"
dataId = scrape_from_root(url, dataId) 

url = "http://aaas.confex.com/aaas/2013/webprogram/CLINIC.html"
dataId = scrape_from_root(url, dataId)

url = "http://aaas.confex.com/aaas/2013/webprogram/SPONSOR.html"
dataId = scrape_from_root(url, dataId)

url = "http://aaas.confex.com/aaas/2013/webprogram/SYMP.html"
dataId = scrape_from_root(url, dataId)
