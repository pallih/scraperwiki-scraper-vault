...
for pageNo in range(1, numberOfpages + 1):
    ...
    for tr in soup.findAll('tr', 'nvm'):
        ...
        for spec in tr.findAll('p', 'specs'):
            realItem['postcode'] = spec('span', limit=2)[0].string
            realItem['city'] = spec('span', limit=2)[1].string
        ...
        print 'items saved: ' + str(len(items))import BeautifulSoup, scraperwiki, datetime
