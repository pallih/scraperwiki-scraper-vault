...
# East Midlands Planning Applications
...
#scrape_lib.restart_authority('Nottingham')
#scrape_lib.remove_authority('Kings Lynn')
...
#auth_list = scrape_lib.get_auths(['Boston']) # NB simple string is a region, list is a list of authorities
