# this is a scraper of Monmouthshire planning applications for use by Openly Local

# also see Braintree and Hyndburn
...
class MonmouthshireScraper(base.DateScraper):
    ...
    search_url = 'http://idox.monmouthshire.gov.uk/WAM/findCaseFile.do'
...
if __name__ == 'scraper':
    ...
    # misc tests
    #print scraper.get_detail_from_uid ('DC/2012/00278')
