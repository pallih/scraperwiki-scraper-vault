...
#scrape_lib.restart_authority('Carmarthenshire')
...
#update_authorities()
#auth_list = scrape_lib.get_auths(['Wrexham']) # NB simple string is a region, list is a list of authorities
#scrape_lib.gather_applications(auth_list[0], DB_START, DB_END, 100, 120)
