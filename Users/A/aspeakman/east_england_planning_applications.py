...
# East England Planning Applications
...
NUM_PER_DAY = 15 # number of authorities updated on each run
...
#scrape_lib.remove_authority('Watford') 
...
#auth_list = scrape_lib.get_auths(['North York Moors']) # NB simple string is a region, list is a list of authorities
...
#util.replace_vals('applications', 'reference', ' (click for more details)', '', 'suffix', True)
