...
# South West Planning Applications
...
#scrape_lib.restart_authority('Dartmoor')

#uncomment these lines to to do a short test scrape on one authority
#auth_list = scrape_lib.get_auths(['Mendip']) # NB simple string is a region, list is a list of authorities
#scrape_lib.gather_applications(auth_list[0], DB_START, DB_END, 20, 0)
