...
# South East Planning Applications
...
#auth_list = scrape_lib.get_auths(['Isle of Wight']) # NB simple string is a region, list is a list of authorities
#scrape_lib.gather_applications(auth_list[0], DB_START, DB_END, 50)
