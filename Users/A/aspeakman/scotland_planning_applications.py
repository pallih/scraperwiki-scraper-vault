...
# Scotland Planning Applications
...
MAX_PER_SESSION = 50 # maximum records to get in one go from one authority
NUM_PER_DAY = 10
...
#scrape_lib.restart_authority('Wigan')

#uncomment these lines to to do a short test scrape on one authority
#auth_list = scrape_lib.get_auths(['Western Isles']) # NB simple string is a region, list is a list of authorities
#scrape_lib.gather_applications(auth_list[0], DB_START, DB_END, 50, 0)
