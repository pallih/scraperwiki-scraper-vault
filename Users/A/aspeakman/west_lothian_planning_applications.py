# this is a scraper of West Lothian planning applications for use by Openly Local

# also see Tower Hamlets, Colchester, Nottingham
...
class WestLothianScraper(base.PeriodScraper):
...
if __name__ == 'scraper':
    ...
    # misc tests
    #print scraper.get_detail_from_uid ('0346/FUL/12')
    #result, dt1, dt2 = scraper.get_id_period(util.get_dt('01/03/2011'))
    #result, dt1, dt2 = scraper.get_id_period(util.get_dt('11/05/2009'))
