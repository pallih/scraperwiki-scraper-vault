...
//////////////////////////////////// EDIT BELOW HERE:
$html_content = scraperwiki::scrape("http://www.laptop-lcd-screen.co.uk/laptopparts/laptopparts_showparts.asp"); // THE PAGE WE'RE SCRAPING
//////////////////////////////////// EDIT ABOVE HERE:

$html = str_get_html($html_content); // CREATING A HANDY VARIABLE TO USE LATER.

foreach ($html->find("table tbody tr td table tbody tr td table tbody tr td div h2 a") as $title) { //DEFINING THE PRODUCT TITLE SEARCH CRITERIA.           
    ...
    $further_html_content = scraperwiki::scrape("http://www.laptop-lcd-screen.co.uk".$link_data[0].".asp"); // THE FURTHER PAGES WE'RE SCRAPING
...
// GETTING THE PRODUCT REF.    
    foreach ($further_html->find("table tbody tr td h3 strong") as $product_ref) { //DEFINING THE PRODUCT CODE SEARCH CRIETERIA.
    ...
    //echo $product_code_array[2] ."\n"; // ECHO OUT PRODUCT REF
    };


// GETTING THE EX VAT PRICE
    foreach ($further_html->find("table tbody tr td h2 strong") as $product_xvat) { //DEFINING THE PRODUCT CODE SEARCH CRIETERIA.
