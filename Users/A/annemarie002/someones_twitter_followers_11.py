...
print url
followers_AMSS002 = AMSS002.loads(scraperwiki.scrape(url))
# print "Found %d followers of %s" % (len(followers_json), SCREENNAME)
followers_AMSS002 = followers_AMSS002['ids'] # get earliest followers first for batching
followers_AMSS002.reverse()
