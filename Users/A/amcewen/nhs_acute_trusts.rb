# Scraper to get the websites for all the Acute Trusts in the NHS
require 'nokogiri'
require 'open-uri'

DB_NAME = "nhs_trusts_acute"
index_url = "http://www.nhs.uk/ServiceDirectories/Pages/AcuteTrustListing.aspx"

def find_trust_website(info_url)
  info_page = ScraperWiki.scrape(info_url)
  info_doc = Nokogiri::HTML(info_page, nil, 'utf-8')
  record = { 'name' => info_doc.css("h1.acute-trust").inner_text }
