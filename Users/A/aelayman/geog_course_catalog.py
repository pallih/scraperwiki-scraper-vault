...
for titlerow in root.cssselect("table[bgcolor='#ccffcc']"):
    ...
    print data
    # save data
    scraperwiki.sqlite.save(unique_keys=['dept','course_number'], data=data)# This scraper pulls the course titles from the spring 2013 time schedule fror the department of geography at UW
