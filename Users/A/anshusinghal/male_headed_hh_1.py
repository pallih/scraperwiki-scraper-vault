...
uri = "http://www.censusindia.gov.in/Census_Data_2001/Census_Data_Online/Household_Population/Male_Headed_HH.aspx"
...
#print control.name, control.value, control.type
    ...
    for i in response.cssselect("tr.GridRows td"):
        if l_c<2:
            ...
            l_c=0
            data.append(row)
            scraperwiki.sqlite.save(unique_keys=["S_no"],data={"S_no":s_no,"States":row[1],"Males_headed_household":row[2]})
