...
#html = urllib.urlopen("http://www.zigsa.com/tropo/web_site_to_be_scrapped.html").read()
#html = open('file.txt').read()
html = scraperwiki.scrape("http://www.zigsa.com/tropo/web_site_to_be_scrapped.html")
