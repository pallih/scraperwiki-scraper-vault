...
<head>
    ...
    <title>Hackney Planning Applications Map</title>
...
var sourcescraper = 'hackney_planning_applications';
...
{
    col = 'D85454';
    if (record["status"] == "Pending Consideration")
    {
        col = '54B8B4';
    } 
...
function makemap()
{
    var mapOptions = { "zoom": 12, "center": new google.maps.LatLng(53.385313,-1.463622), 
...
function loaddata() 
{
    ...
    // url = "http://scraperwiki.com/scrapers/planning_test/"
    // alert(url);
