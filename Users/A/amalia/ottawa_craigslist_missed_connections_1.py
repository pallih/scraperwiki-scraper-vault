...
def our_scraper(our_url):
    ...
    gender_types = ['m4m', 'm4w', 'w4w', 'w4m'];

    for every_post in re.finditer('<a href="http://newyork.craigslist.org/mnh/mis/(.+?).html">.+?</a>', the_page):
                ...
                full_listing_url = "http://newyork.craigslist.org/mnh/mis/" + str(post_id) + ".html"
                ...
                try:
                    ...
                    # cleans gender designator, there were some instances in which it pulled more of the title with it
                    for type in gender_types:
                        if post_gender.find(type) > -1:
                            post_gender = type
...
base_link = "http://newyork.craigslist.org/mnh/mis/index"
base_number = 200
