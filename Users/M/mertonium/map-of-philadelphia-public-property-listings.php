...
var sourcescraper = 'philadelphia-public-property-listings';
    ...
    for (i = 0; i < 10; i++) {
        ...
        geocoder.geocode( { 'address': address}, function(results, status) {
            if (status == google.maps.GeocoderStatus.OK) {
                ...
                */
                r[i].latlng = results[0].geometry.location;
            } else {
...
$(function() { geocoder = new google.maps.Geocoder(); makemap(); loaddata(); });
var geocoder; // Big, happy, global var.
