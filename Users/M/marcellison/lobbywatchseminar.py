...
('Cookie', 'WEBTRENDS_ID=24.85.235.62.1366084508173719; __utma=228279554.904766632.1366084790.1371783956.1372001511.32;__utmz=228279554.1372001511.32.22.utmcsr=google|utmccn=(organic)|utmcmd=organic|utmctr=(not%20provided); __utmc=228279554;JSESSIONID=00002dsj_JggfUu5XcfpAgqZxN8:15gm0ddj0')]
    ...
    for a in soup.findAll('a'):
        try:
            if str(a.get('name')) == 'top':
                ...
                print "*** THIS IS THE URL FOR DETAIL PAGE " + url
...
def run():
    ...
    for councillor in TEST_COUNCILLOR_LIST:
        ...
        print "*** THIS IS THE URL WE ARE TRYING TO ACCESS: " + url
        ...
        print "*** THIS IS THE NUMBER OF PAGES WE ARE GOING TO SCRAPE: " + str(numberOfPages)
...
def runDBQuery():
    ...
    #scraperwiki.sqlite.commit()
    result = scraperwiki.sqlite.execute("select count(*) from lobbying where councillor = 'Rob Ford'")
    print "*** There are " + str(result) + " results found for Rob Ford."
