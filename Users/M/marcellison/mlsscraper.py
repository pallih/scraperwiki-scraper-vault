...
#scraperwiki.sqlite.execute("delete from investigations where ward in ('S19','S20')")
#scraperwiki.sqlite.commit()
...
# sometimes the server is sensitive to this information
br.addheaders = [('User-agent', 'Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.9.0.1) Gecko/2008071615 Fedora/3.0.1-1.fc9 Firefox/3.0.1'),
('Cookie', 'WEBTRENDS_ID=192.206.151.130.1371819178837082; __utma=228279554.616733573.1371840655.1376512182.1376579671.60; __utmz=228279554.1376579671.60.53.utmcsr=google|utmccn=(organic)|utmcmd=organic|utmctr=(not%20provided); __utmc=228279554; JSESSIONID=00006mFO_bO4aijgkTk4D-cWfkr:162rr17fd')]
