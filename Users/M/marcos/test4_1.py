...
class OneSpider(CrawlSpider):
    ...
    rules = (Rule(SgmlLinkExtractor(allow=('symb=Q',)), follow=True, callback='parse_item'),)
...
class SWPipeline(object):
    ...
    def write_data(self, spider):
        ...
        scraperwiki.sqlite.save(table_name='test_tablei', unique_keys=unique_keys, data=self.data)
        self.data = []
