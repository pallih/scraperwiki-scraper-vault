...
#p Twitter.search('"Private cloud job"', :count => 100, :max_id => cur_id).results.map.count
...
#    p " #{status.created_at} #{status.id}/#{status.from_user}: #{status.text}  %%% #{status.source} *** #{status.urls}"
 ...
 #p Twitter.status(245174523912126464)

 #p Twitter.status(209584578506133505).text 

 #p Twitter.status(245174523912126464).user.lang
 #p Twitter.status(245174523912126464).id
 #p Twitter.status(245174523912126464).user.id
 #p Twitter.status(245174523912126464).user.location
 #pp = Twitter.status(245174523912126464).user.status.attrs
