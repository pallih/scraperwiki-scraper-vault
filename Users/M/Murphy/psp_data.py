...
for page in range(0,10):
    url = "http://www.metacritic.com/browse/games/release-date/available/psp/name?view=detailed&page=%s" % page
    ...
    for product in products:
        ...
        scraperwiki.sqlite.save(unique_keys=['title','url','release'], data=data)# PSP Game Scraper
import scraperwiki
import lxml.html
import re
