...
for page in range(0,22):
    url = "http://www.metacritic.com/browse/games/release-date/available/ds/name?view=detailed&page=%s" % page
    ...
    for product in products:
        ...
        scraperwiki.sqlite.save(unique_keys=['title','url','release'], data=data)# DS Game Scraper
import scraperwiki
import lxml.html
import re
