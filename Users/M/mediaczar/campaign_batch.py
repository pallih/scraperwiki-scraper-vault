...
search_terms = ['we are social'] # output from bigram_count.pl process
...
# Build the target URL
        page_name = base_url + "%22" + search_term.replace(" ", "%20") + "%22/sortby/date/dateGroup/all/page/" + str(page_num)
        html = scraperwiki.scrape(page_name)
        html = lxml.html.fromstring(html)
