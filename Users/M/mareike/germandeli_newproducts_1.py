...
# scraperwiki benoetigt eine liste von dictionaries fuer die speicherung als sqlite tabelle 
    ...
    for l in links[:50]:
        ...
        #try:          
            ...
            if div:
                 ...
                 perishable_image_link = perishable_image['src']
                 if perishable_image_link in perishable.keys():
                      perishable_data = perishable[perishable_image_link]
                      linkdata['perishable'] = perishable_data
                 else:
                      print "Unknown link for perishable image!"
