...
url = 'http://www.gpupdate.net/en/standings/187/2013-indycar-series-standings/'
...
for row in table.findAll('tr')[1:40]:
    ...
    scraperwiki.sqlite.save(unique_keys=["driver"], data={"pos":pos, "country":country, "driver":driver, "team":team, "points":points})
