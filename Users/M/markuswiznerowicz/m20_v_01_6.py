...
### http://cordis.europa.eu/newsearch/index.cfm?page=resultListGET&combo_orderby=all&Summary=quick&ENGINE_ID=CORDIS_ENGINE_ID&nPage= 1 &all_words=TRANSPORT&combo_resultperpage=10&form_id=simple_search&SEARCH_TYPE_ID=CORDIS_SEARCH_ID&useraction=simple_search&REF_PROGRAMMEACRONYM=FP7-TRANSPORT&REF_Collection=EN_PROJ

Linkteil1 = 'http://cordis.europa.eu/newsearch/index.cfm?page=resultListGET&combo_orderby=all&Summary=quick&ENGINE_ID=CORDIS_ENGINE_ID&nPage='
Linkteil2 = '&all_words=TRANSPORT&combo_resultperpage=10&form_id=simple_search&SEARCH_TYPE_ID=CORDIS_SEARCH_ID&useraction=simple_search&REF_PROGRAMMEACRONYM=FP7-TRANSPORT&REF_Collection=EN_PROJ'
Seite = 1
