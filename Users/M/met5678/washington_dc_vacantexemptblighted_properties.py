...
all_properties = []
#instantiant geocoder and loop counter
#encoder = geocoder()
#count = 0
...
def run_form_mechanize():
    br = mechanize.Browser()
    br.open('https://www.taxpayerservicecenter.com/RP_Search.jsp?search_type=Assessment')
    br.select_form(name="SearchForm")
    br["txtBuildingNumber"] = all_properties[0]['street_number']
    br["txtStreetName"] = all_properties[0]['street_name']
    br["txtThoroughfare"] = [all_properties[0]['street_suffix']]
    br["txtQuadrant"] = [all_properties[0]['street_quadrant']]
