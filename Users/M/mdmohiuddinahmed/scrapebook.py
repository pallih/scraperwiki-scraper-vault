...
startpagebaseurl='http://haverfordpafootball.stackvarsity.com/photos/Default.asp?page='

#for 530 pages

for pageno in range(1,550):
    startpagehtml = scraperwiki.scrape("http://haverfordpafootball.stackvarsity.com/photos/Default.asp?page="+str(pageno))
