# adapted from C. Marriott's scraper, modified to scrape the review body text as well as the review metadata
...
while page < 3:
    ...
    for review_link in review_links:
        ...
        review_text = review_tree.cssselect('div#main div.editorial')[0].text_content()
