...
KML_URL = "http://services.salford.gov.uk/data/kml/public-toilet.kml"
ONS_CODE = "E08000006"
...
for toilet in soup.findAll('placemark'):
    ...
    # Horrid Hack!
    cleaned_data['postcode'] = toilet_name + ', Salford'
    
    #Address
    cleaned_data['address'] = toilet_name + ', Salford'
    ...
    cleaned_data['toilet_id'] = md5.md5(toilet_name + ' Salford').hexdigest()
