            ...
            if i == 1:
                ...
                for lord in tmp:
                    try:
                        ...
                        # This one must be second
                        lord_split = lord.rsplit('-', 1)
                        if len(lord_split) != 2:
                            print "unexepected number of items, should be just name, party separated by -:", lord
                            raise Exception("lord split failed")
                        name, party = lord_split
