...
scraperwiki.metadata.save('data_columns', ['id', 'title', 'description', 'price', 'endDate'])

host = "http://api.scraperwiki.com/api/1.0/datastore/getdata?format=json&name=ebay-items&limit=500&offset=861" #
