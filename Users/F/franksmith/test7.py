...
#    urlList.append("http://entertainment-memorabilia.shop.ebay.com/Entertainment-Memorabilia-/45100/i.html?LH_NOB=1..9%2C999&_nkw=%28beatle*%2C+lennon%2C+mccartney%29&rt=nc&_LH_NOB=1&_adv=1&_fsct=&_in_kw=2&_ipg=200&_oexkw=&_okw=beatle*+lennon+mccartney&_sc=1&_sop=16&_udhi=&_udlo=")
    ...
    urlList.append("http://www.ebay.com/sch/i.html?LH_Auction=1&_sadis=200&LH_SALE_CURRENCY=0&_sacat=0&_ftrt=901&_sabdhi=999&_ftrv=1&_sabdlo=1&_adv=1|1&_sop=3&_nkw=%28beatles%2C+lennon%2C+%22george+harrison%22%2C+ringo%2C+mccartney%29&_dmd=1&_okw=beatles+lennon+mccartney&_LH_NOB=1&LH_NOB=1&_ipg=200&rt=nc&_jsoff=1")

    for i in range(2,15):
        urlDescriptionList.append("beatles+lennon+mccartney, NoB>0")
        urlList.append("http://www.ebay.com/sch/i.html?LH_Auction=1&_sadis=200&LH_SALE_CURRENCY=0&_sacat=0&_ftrt=901&_sabdhi=999&_ftrv=1&_sabdlo=1&_adv=1|1&_sop=3&_nkw=%28beatles%2C+lennon%2C+%22george+harrison%22%2C+ringo%2C+mccartney%29&_dmd=1&_okw=beatles+lennon+mccartney&_LH_NOB=1&LH_NOB=1&_ipg=200&_skc=" + str((i-1)*200) + "&rt=nc&_pgn="+str(i)+"&_jsoff=1")
...
# 2013-01-24 ebay started a new search that requires javascript. At least for now we can add "&_jsoff=1" and get around it
    ...
    urlList.append("http://shop.ebay.com/i.html?_nkw=beatles+%28remco%2Cselcol%2Cprimrose%2Canglo%2Cjaymar%2Clilo%2Cmascot%2Cbrooch%29&_sacat=0&_sop=10&_dmd=1&_odkw=beatles+%28remco%2Cselcol%2Cprimrose%2Canglo%2Cjaymar%2Clilo%29&_osacat=0&_jsoff=1")
