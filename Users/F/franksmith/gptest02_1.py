...
#    print "Category Page Read Count: ", categoryPageCount
    ...
    while len(categoryList) != 0 :
        ...
        for listIndex, element in enumerate(categoryList):
            ...
            for1Counter += 1
#            print tempHref
#          if tempHref.find("beatles-apparel") != -1 :
            page1 = readUrl(tempHref)
            categoryPageCount += 1
   #         print "Category Page Read Count: ", categoryPageCount
#            print page1
#            x = categoryList.pop(listIndex)
#            print "Popped: ", x
...
#            categoryList2 = page1.xpath(categoryPageCategoryLinksTag)
#            productList2 = page1.xpath(listProductLinksTag)
#            print "New Length: ", len(categoryList)
#            print categoryList2
#            print "Product Links: ", len(productList)
#            print productList2
            for2Counter = 1
            for productIndex, productLink in enumerate(productList):
                ...
                for2Counter += 1
#                print tempHref
   #             productscrape(tempHref)
                productPageCount += 1
   #             print "Product Page Read Count: ", productPageCount
                productLinkCount += 1
   #             print "Total Products: ", productLinkCount
#                x = productList.pop(productIndex)
#                print "Popped Product: ", x
#                print "Length Product: ", len(productList)
            productList = []
...
def BuildCurrentList(urlList, urlDescriptionList):
    ...
    for listIndex, url in enumerate(urlList):
        categoryList = []
        productList = []
        categoryList, productList = categorysearch(url)
