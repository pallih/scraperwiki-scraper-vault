...
###  Make Offer or not
    ...
    print "PRICE: " + str(root.xpath(itemPriceTag)[0])
    print list(root.xpath(itemPriceTag)[1].itertext())
    print "ID: " + str(root.xpath(itemPriceTag + '/@id')[0])
...
#    if 1 == 1 :
        print "Update the tables - but not really"
        UpdateFlag = "No"
