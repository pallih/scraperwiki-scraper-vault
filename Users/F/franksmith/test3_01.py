...
def ScrapeAuction(inItemNumber):
  ...
  sellerTag1 = "//table[contains(@class,'s-content')]//span[@class='mbg-nw']"
  sellerFeedbackTag1 = "//table[contains(@class,'s-content')]//a[@class='mbg-fb']//*"
  sellerFeedbackPercentageTag1 = "//table[contains(@class,'s-content')]//span[@class='s-gray z_a']"
  sellerTag2 = "//span[@class='mbg-nw']"
  sellerFeedbackTag2 = "//a[@class='mbg-fb']//*"
  sellerFeedbackPercentageTag2 = ""   ## Feedback Percentage isn't displayed
...
#  ItemDescriptionText = normalize_whitespace(root.xpath(descriptionTag)[0].text_content())
  ...
  try:
      Seller = root.xpath(sellerTag1)[0].text
  except:
      try:
          Seller = root.xpath(sellerTag2)[0].text
      except:
          Seller = None

  
  try:
      SellerFeedback = root.xpath(sellerFeedbackTag1)[0].tail
  except:
      try:
          SellerFeedback = root.xpath(sellerFeedbackTag2)[0].tail
      except:
          SellerFeedback = None
