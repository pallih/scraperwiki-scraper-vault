...
def BuildActiveList():
    ...
    existingList = []
    existingDict = {}
    scraperwiki.sqlite.attach("test7")
    activeDict = scraperwiki.sqlite.select("auctionNumber from test7.newTable")
    print activeDict
...
### Title, Description, and Seller selection Begin
    ...
    try:
        ...
        ItemDescriptionHTML = "unknown"
        ItemDescriptionText = "unknown"
        saveError(ItemNumber,"Description unknown, HTML node=unknown")
...
#Next, append to the active list, the items from the test7 "newTable"
