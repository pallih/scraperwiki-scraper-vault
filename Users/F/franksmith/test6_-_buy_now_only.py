...
#    urlList.append("http://entertainment-memorabilia.shop.ebay.com/Entertainment-Memorabilia-/45100/i.html?LH_NOB=1..9%2C999&_nkw=%28beatle*%2C+lennon%2C+mccartney%29&rt=nc&_LH_NOB=1&_adv=1&_fsct=&_in_kw=2&_ipg=200&_oexkw=&_okw=beatle*+lennon+mccartney&_sc=1&_sop=16&_udhi=&_udlo=")
    ...
    urlDescriptionList.append("beatle*+lennon+mccartney+george harrison+ringo, buy now")
    urlList.append("http://www.ebay.com/sch/i.html?_adv=1&_okw=beatle*+lennon+mccartney&_LH_NOB=1&_nkw=%28%28beatle*%2C+lennon%2C+%22george+harrison%22%2C+ringo%2C+mccartney%29%29&_in_kw=1&_ex_kw=&_sacat=0&_okw=&_oexkw=&_adv=1&_udlo=&_udhi=&LH_BIN=1&LH_Time=1&_ftrt=901&_ftrv=24&_sabdlo=1&_sabdhi=999&_samilow=&_samihi=&_sadis=200&_fpos=&_fsct=&LH_SALE_CURRENCY=0&_sop=3&_dmd=1&_ipg=200")


    for i in range(2,30):
        urlDescriptionList.append("beatle*+lennon+mccartney+george harrison+ringo, buy now")
        urlList.append("http://www.ebay.com/sch/i.html?_sadis=200&LH_SALE_CURRENCY=0&_sacat=0&_samihi=&_fpos=&_oexkw=&LH_Time=1&_sop=3&_nkw=%28%28beatle*%2C+lennon%2C+%22george+harrison%22%2C+ringo%2C+mccartney%29%29&_okw=beatle*+lennon+mccartney|&_fsct=&LH_BIN=1&_samilow=&_udhi=&_ftrt=901&_sabdhi=999&_ftrv=24&_udlo=&_sabdlo=1&_adv=1|1&_dmd=1&_LH_NOB=1&_ipg=200&_skc=" + str((i-1)*200) + "&rt=nc&_pgn="+str(i))
