...
<h2>Map of locations providing free meals in DC<span id="scrapername">...</span> <em id="message">...</em></h2>
...
services = 'n/a';
    ...
    return '<b>Organization: </b>'+record['organization']+'<br><b>Services: </b>'+services;
}
