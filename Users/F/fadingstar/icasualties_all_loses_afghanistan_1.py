...
for s in states:    
    ...
    for row in rows:
        ...
        if table_cells: 
            ...
            scraperwiki.sqlite.save(unique_keys=["Name"], data={"Name":Name, "Date":Date, "Rank" : Rank, "Age":Age, "Unit": Unit, "Branch": Branch, "State": State, "City": City, "Cause": Cause, "Place_of_Death": Place_of_Death, "Died_In": Died_In, "Nationality": s[24:]}, table_name='icasualities_plus')import scraperwiki           
import lxml.html
