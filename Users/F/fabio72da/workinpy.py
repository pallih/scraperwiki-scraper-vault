...
html_content = scraperwiki.scrape("http://cantieri.mit.gov.it/index.php/tutte-le-opere/101")
html = lxml.html.fromstring(html_content) #$html = str_get_html($html_content);



urlbase="https://cantieri.mit.gov.it" #$urlbase="https://www.serviziocontrattipubblici.it/ricerca/";
urllist="cerca_appalti.aspx"; #$urllist="cerca_appalti.aspx";
...
"""
print ">> Sessione conclusa >>Totale cantieri acquisiti: "+str(numScraped)
import scraperwiki
import lxml.html
import urllib, urllib2, datetime, time, re, copy
