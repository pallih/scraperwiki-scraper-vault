...
urlbase="https://www.serviziocontrattipubblici.it/ricerca/" #$urlbase="https://www.serviziocontrattipubblici.it/ricerca/";
...
#html_content = scraperwiki.scrape(urlbase+urllist)
html_content = urllib2.urlopen(urlbase+urllist).read();
