# Metacritic Xbox 360 Game Scraper
import scraperwiki
import lxml.html
import re
...
for page in range(0,14):
    ...
    for product in products:
        ...
        scraperwiki.sqlite.save(unique_keys=['title','url','rating','release','genre','publisher'], data=data)# Metacritic Xbox 360 Game Scraper
import scraperwiki
import lxml.html
import re
