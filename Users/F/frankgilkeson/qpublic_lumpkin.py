...
def scrape_and_look_for_next_link(url):
    ...
    scrape_table(root)
    next_link = root.cssselect("a.Next Parcel")
    print next_link
    if next_link:
...
base_url = 'http://qpublic7.qpublic.net/ga_display.php?county=ga_lumpkin&KEY='
starting_url = urlparse.urljoin(base_url, '074++++036')
