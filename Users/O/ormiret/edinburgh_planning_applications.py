...
def scrape_detail(id):
    ...
    url = 'https://citydev-portal.edinburgh.gov.uk/idoxpa-web/applicationDetails.do?activeTab=details&keyVal='+id
    ...
    record['parish'] = root.xpath('.//table//th[contains(text(), "Parish")]')[0].getnext().xpath('.//text()')[0]
...
search_url = 'https://citydev-portal.edinburgh.gov.uk/idoxpa-web/search.do?action=weeklyList'
