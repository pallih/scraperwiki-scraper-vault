...
ufo_years = ['2009', '2008', '2007', '2006', '2005', '2004']

minus_rows_skfo = [23, 29, 36, 43, 51, 52, 67, 74, 87]
minus_rows_ufo = [23, 29, 36, 50, 51, 66, 73, 86]
...
for elem in years:
    ...
    while i<97: 
        if not i in minus_rows:
            ...
            region = sheet.cell(i, 0).value.strip()
    ...
    print 'Готов парсинг за ' + elem + ' год. Имя таблицы "gibdd'+elem+'".'import scraperwiki           
import xlrd
