###############################################################################
# CA Interpreters - the Python Version
#
# This script starts on the first page and then
# scrapes it an all subsequent pages by calling
...
BASE_URL  = 'http://www.jsonline.com/watchdog/dataondemand/33532074.html?appSession=85014365520650'
FIRST_EXT = '&PageID=2'
MAX_PAGES    = 4  ## set to 0 for unlimited
...
def scrape_table(page_url):
    ...
    if MAX_PAGES == CURRENT_PAGE:
        ...
        next_link = None  ## for the end-of-the-list case
