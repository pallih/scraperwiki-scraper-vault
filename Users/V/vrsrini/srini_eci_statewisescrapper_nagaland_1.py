...
#states = {'Nagaland':'s17', 'Goa':'s05', 'Manipur': 's14', 'Punjab':'s19','Uttarakhand':'s28'}
...
def process_state(state, number):
    ...
    for x in results[4:15]: #skip the first 4 tr's and the last one
        ...
        scraperwiki.sqlite.save(unique_keys=['constituency_no'], data=record, table_name='nagaland-elections')   
