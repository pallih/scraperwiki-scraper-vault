...
def scrape_people(role='alumni'):
    ...
    for i in range(1,100):
        r = requests.get('http://www.hyperisland.com/people?filter=true&role=alumni' % (role,i))
            ...
            if len(dom.cssselect('div.community_list')):
                ...
                for td in dom.cssselect('div.community_list td'):
                    person = {
                        ...
                        'course': scrape_people(role='alumni')
...
geocode_nationalities('alumni')import scraperwiki
import requests
import lxml.html
