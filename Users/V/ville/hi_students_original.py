...
def scrape_people(role='coworkers'):
...
def geocode_nationalities(role='coworkers'):
    import json
...
scrape_people('coworkers')
geocode_nationalities('coworkers')import scraperwiki
import requests
import lxml.html
...
scrape_people('coworkers')
geocode_nationalities('coworkers')