...
class extractor(object):
    ...
    def extract_published_date(self):
        published_date = self.extract_metadata('name="DC.date.issued"')
        if published_date:
    ...
    def extract_authors(self):
        authors = self.extract_metadata('name="DC.creator"')
        if authors:
    ...
    def extract_title(self):
        title = self.extract_metadata('property="og:title"')
    ...
    def extract_publisher(self):
        self.article.set_metadata_value('producer', 'The Washington Post', 'false')

    def extract_distributor(self):
        self.article.set_metadata_value('distributor', 'The Washington Post', 'false')
...
class exporter(object):
    ...
    def drop_tables(self):
        self.drop_table('%s_entities' % self.scraper_name)
        self.drop_table('%s_raw' % self.scraper_name)
...
def extract_all_articles():
    ...
    for news_article in root_navigator.linked_articles:
        ...
        news_exporter = exporter(news_article, 'washington_post')
...
extract_all_articles()__author__ = 'bmihelic'
