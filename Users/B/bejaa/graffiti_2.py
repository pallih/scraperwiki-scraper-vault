...
def search(queries = [], results_per_page = 100, language = 'en', num_pages = 15, save_author_info = True, lat=None, lng=None, radius=None ):
    '''
    ...
    for query in queries:
        for page in range(1, num_pages + 1):
            ...
            if lat and long and radius:
                base_url += '&geocode=%s,%s,%smi' % (lat, lng, radius)
            try:
...
search(['graffiti'], num_pages=10, lat='40.714623', lng='-74.0066050', radius=5)
