...
XML_ZIP='http://clinicaltrials.gov/ct2/results/download?down_stds=top10&down_typ=study&down_flds=shown&down_fmt=plain&cntry1=EU%3AGB&show_flds=Y&show_down=Y'
#http://clinicaltrials.gov/ct2/results/download?down_stds=top100&down_typ=fields&down_flds=all&down_fmt=xml&term=lung+cancer&show_down=Y
#http://clinicaltrials.gov/ct2/results/download?down_stds=top10&down_typ=study&down_flds=shown&down_fmt=plain&cntry1=EU%3AGB&show_flds=Y&show_down=Y
#http://clinicaltrials.gov/ct2/results/download?down_stds=all&down_typ=fields&down_flds=shown&down_fmt=plain&term=lung+cancer&show_down=Y
...
for page in listing:
    ...
    sponsorDG, sponsorList = parsePage(xmlRoot, sponsorDG, sponsorList)
'''
graphOut(sponsorDG)##Trying out the unzip method found here:
#https://scraperwiki.com/scrapers/un_peacekeeping_statistics/
import tempfile, zipfile, urllib
