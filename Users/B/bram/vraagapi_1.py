...
# json container ? 
url = 'https://api.scraperwiki.com/api/1.0/datastore/sqlite?format=jsondict&name=imagetest&query=select%20*%20from%20%60fotostext%60%20limit%2010'
