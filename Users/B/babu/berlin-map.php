...
var sourcescraper = 'berlinde-veranstaltungsorte';
...
{
    return '<a href="'+record['link']+'" target="_blank">'+record["Reference_number"]+'</a>';
}
...
function makemap()
{
    var mapOptions = { "zoom": 11, "center": new google.maps.LatLng(52.522906,13.41156, -4.128317), 
...
function recorddata(record)
{
    ...
    console.log(record['geo']["geometry"]["location"]["lat"]);

    pos = new google.maps.LatLng(record['geo']["geometry"]["location"]["lat"], record['geo']["geometry"]["location"]["lng"]); 
