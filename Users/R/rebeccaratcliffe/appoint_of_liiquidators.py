...
#TO ADD: AN ELSE TO ADDRESS DATE/URLCODE WHICH ARE 'OUT OF RANGE' ON SOME PAGES        
        if lines:
            ...
            record['company number'] = spans[3].text
            record['company name'] = spans[4].text
            record['previous name'] = spans[5].text
            record['type of liquidation'] = spans[6].text
            record['address of registered office'] = spans[7].text
            record['principle trading address'] = spans[8].text
            record['liquidator details'] = lines[11].text
            record['office holder number'] = spans[2].text
