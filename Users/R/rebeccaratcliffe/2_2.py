...
def scrape_table(root):
    ...
    record['principle trading address'] = search_xpath(root, "//span[@rel='organisation:hasPrincipalTradingAddress']//span[@property='vCard:label']")
