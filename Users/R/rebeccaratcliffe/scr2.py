...
#If you want to understand this scraper - start at the bottom where it says 'base_url'a
...
#TO ADD: AN ELSE TO ADDRESS DATE/URLCODE WHICH ARE 'OUT OF RANGE' ON SOME PAGES        
        if lines:
            ...
            record['registered office of company'] = spans[8].text
            record['principle trading address'] = spans[9].text
            record['date of appointment'] = spans[8].text
            record['adminstrator details'] = lines[12].text
