...
#TO ADD: AN ELSE TO ADDRESS DATE/URLCODE WHICH ARE 'OUT OF RANGE' ON SOME PAGES        
        if lines:
            ...
            record['previous name of company'] = spans[7].text
            record['principle trading address'] = lines[8].text
            record['further details'] = lines[11].text
            record['company number'] = spans[2].text
            record['officer holder number'] = spans[3].text
