...
# O truque do scraping eh encontrar algo que identifique onde esta aquela determinada informacao dentro da pagina de maneira unica. Para isso existem varias tecnicas... a que utilizamos aqui sao os seletores de CSS [3] a mesma que a gente utiliza quando quer estilar um elemento usando CSS.
