...
scraperwiki.sqlite.execute("CREATE TABLE gandu2 ('fi' string)")
...
for l in list:
    ...
    if xy == 1:
        t1 = tab[ij]
        #print t1
        #t2 = t1.findAll(name = 'span', attrs = {"class": ""})
    ...
    print '%s    $  %s' %(fi,se)
    #print se
    scraperwiki.sqlite.execute("insert into gandu2 values (?)",(se))
    scraperwiki.sqlite.commit()
