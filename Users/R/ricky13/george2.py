...
scraperwiki.sqlite.execute("CREATE TABLE George2 ('Full name' string,'Title' string,'Department' string,'Phone' string,'Email' string,'Location' string,'Education' string)")
scraperwiki.sqlite.commit()

letters = ['a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z']
for ch in letters:
    print ch
    add = 'http://explore.georgetown.edu/faculty/index.cfm?Action=List&Letter='+ch.upper()+'&AffiliationID=334'
    ...
    for link2 in link:
        if cnt >= 21 :
            ...
            scraperwiki.sqlite.execute("insert into Cccgeorge2 values (?,?,?,?,?,?,?)", (fn,ti,de,ph,ema,locat,edustring))
            scraperwiki.sqlite.commit()
