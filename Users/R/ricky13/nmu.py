...
#scraperwiki.sqlite.execute("CREATE TABLE nagg ('Name' string)")
...
for l in list:
    ...
    print Soup.dt(13)
    #print tab
    #print tab[3].renderContents.string.strip()
    #for va in tab.findAll('td'):
        #print va.renderContents
    #print len(tab)
    #for va in tab:
     #   if va.renderContents.strip() == 'Preferred Name:':
      #      print 'getting'
