...
class Clubs(object):
    ...
    names = (
        ...
        (8, 'LIV', 'Liverpool'),
        (9, 'MCI', 'Man City'),
        (10, 'MUN', 'Man Utd', 'Man United'),
        (11, 'NEW', 'Newcastle'),
        (12, 'NOR', 'Norwich'),
        (13, 'QPR', 'QPR'),
        (14, 'STO', 'Stoke City', 'Stoke'),
        (15, 'SUN', 'Sunderland'),
        (16, 'SWA', 'Swansea'),
        (17, 'TOT', 'Tottenham'),
        (18, 'WBA', 'West Brom'),
...
def import_player(element):
    player = dict(
        ...
        current_cost=fpl_to_decimal(element['now_cost']),
        max_cost=fpl_to_decimal(element['max_cost']),
        original_cost=fpl_to_decimal(element['original_cost']),
        min_cost=fpl_to_decimal(element['min_cost']),
        total_points=fpl_to_integer(element['total_points']))
