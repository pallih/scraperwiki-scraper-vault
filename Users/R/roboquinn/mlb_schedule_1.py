...
start_date = datetime.datetime(2012, 3, 5)

end_date = datetime.datetime(2012, 3, 10)

for single_date in daterange(start_date, end_date):
    #sdate = datetime.datetime.now()
    sdate_split = str(single_date.year) + str(single_date.month).zfill(2) + str(single_date.day).zfill(2)
    json1 = scraperwiki.scrape("http://mlb.mlb.com/components/schedule/schedule_" + sdate_split + ".json") 

    #json1 = scraperwiki.scrape("http://mlb.mlb.com/components/schedule/schedule_20130401.json")
