...
def parse_list(root):
    ...
    for el in root(".listing a.property_title"):
        ...
        scraperwiki.sqlite.save(unique_keys=['source_url'], data=data, table_name="tripadvisor_rome")
...
start_url = "http://www.tripadvisor.com/AttractionsAjax-g187791?cat=25&o=a%s&sortOrder=popularity"
