...
url = "http://www.london2012.com/mm/Document/Publications/General/01/42/89/01/17DecemberTicketingReport_Neutral.pdf"
...
open('/tmp/data', 'wb').write(xmldata)
del xmldata
gc.collect(2)

root = lxml.etree.parse('/tmp/data')
print "ROOT", root
