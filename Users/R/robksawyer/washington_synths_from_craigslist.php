...
<div id="content">
    <h1 align='center'><a href="http://synthfilter.com" title="Synth Filter">SynthFilter</a>: <a href='http://geo.craigslist.org/iso/us/wa' target='_blank'>Washington</a> - Craigslist</h1>
    ...
    $sourcescraper = 'washington_craigslist_synth_collector';
    ...
    try {
        //https://api.scraperwiki.com/api/1.0/datastore/sqlite?format=jsondict&name=washington_craigslist_synth_collector&query=select%20*%20from%20%60swdata%60%20limit%2010%2C10
        ...
        foreach($data as $d){
            ...
            if(!empty($imageSources)){
                ...
                foreach($imageSources as $imgSrc){
                    ...
                    print "<li class='synth_searched'>Synth query: ".$d->synth_name."</li>";
    ...
    <div class="pager">
        <?php
            if($back >= 0 && $current >= $limit){
                echo "<a href='https://views.scraperwiki.com/run/washington_synths_from_craigslist/?start=".$back."'><< Back</a>";
            }else{
                echo "<a href='#' class='disabled'><< Back</a>";
            }
            if($next > 0){
                echo "<a href='https://views.scraperwiki.com/run/washington_synths_from_craigslist/?start=".$next."'>Next >></a>";
            }else{
