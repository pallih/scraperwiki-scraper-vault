    ...
    <div class="pager">
        <?php
            if($back >= 0 && $current >= $limit){
                echo "<a href='https://views.scraperwiki.com/run/california_synths_from_craigslist/?start=".$back."'><< Back</a>";
            }else{
                echo "<a href='#' class='disabled'><< Back</a>";
            }
            if($next > 0){
                echo "<a href='https://views.scraperwiki.com/run/california_synths_from_craigslist/?start=".$next."'>Next >></a>";
            }else{
