...
<div id="content">
    <h1 align='center'><a href="http://synthfilter.com" title="Synth Filter">SynthFilter</a>: <a href='http://geo.craigslist.org/iso/us/or' target='_blank'>Oregon</a> - Craigslist</h1>
    ...
    $sourcescraper = 'oregon_craigslist_synth_collector';
    ...
    <div class="pager">
        <?php
            if($back >= 0 && $current >= $limit){
                echo "<a href='https://views.scraperwiki.com/run/oregon_synths_from_craigslist_1/?start=".$back."'><< Back</a>";
            }else{
                echo "<a href='#' class='disabled'><< Back</a>";
            }
            if($next > 0){
                echo "<a href='https://views.scraperwiki.com/run/oregon_synths_from_craigslist_1/?start=".$next."'>Next >></a>";
            }else{
