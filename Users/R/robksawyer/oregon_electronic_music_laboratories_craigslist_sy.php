...
$state = scraperwiki::get_var('state'); //Must be Titlecase e.g, Alabama, Michigan. or use an array separated by commas Alabama, Washington
...
$manufacturerQuery = 'Electronic Music Laboratories (EML)'; //You can choose to search only a specific manufacturer or if not, just leave it blank
$ignoreWords = explode(',',scraperwiki::get_var('iw_electronic_music_laboratories'));
