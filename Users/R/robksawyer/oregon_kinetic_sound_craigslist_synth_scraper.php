...
$manufacturerQuery = 'KineticSound'; //You can choose to search only a specific manufacturer or if not, just leave it blank
$ignoreWords = explode(',',scraperwiki::get_var('iw_kinetic_sound'));
                          ...
                          if(!empty($synth)){
                                ...
                                if(!empty($synthName)){
                                     if($synthCounter < $synthDepth || $depthOverride == true || $synthDepth == 0){        
                                          $synthManufacturer = "Kinetic+Sound";
