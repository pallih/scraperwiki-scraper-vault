...
$manufacturerQuery = 'Davoli'; //You can choose to search only a specific manufacturer or if not, just leave it blank
$ignoreWords = explode(',',scraperwiki::get_var('iw_davoli'));
