...
def get_number_of_pages(starturl):
    ...
    payload = {'__EVENTTARGET': 'ctl00$ContentPlaceHolder3$grwIzvestaji', '__EVENTARGUMENT': 'Page$Last','referer':'http://stariportal.ujn.gov.rs/Izvestaji.aspx','__EVENTVALIDATION':EVENTVALIDATION,'__VIEWSTATE':VIEWSTATE,'ctl00$txtUser':'','ctl00$txtPass':'','ctl00$ContentPlaceHolder1$txtSearchIzvestaj':'','__VIEWSTATEENCRYPTED':''}
...
def request_n_return_page(scrape_session,starturl,EVENTVALIDATION,VIEWSTATE,page):
    ...
    payload = {'__EVENTTARGET': 'ctl00$ContentPlaceHolder3$grwIzvestaji', '__EVENTARGUMENT': 'Page$'+str(page),'referer':'http://stariportal.ujn.gov.rs/Izvestaji.aspx','__EVENTVALIDATION':EVENTVALIDATION,'__VIEWSTATE':VIEWSTATE,'ctl00$txtUser':'','ctl00$txtPass':'','ctl00$ContentPlaceHolder1$txtSearchIzvestaj':'','__VIEWSTATEENCRYPTED':''}
