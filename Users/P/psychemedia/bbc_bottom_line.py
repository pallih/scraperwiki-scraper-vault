...
def addDBrecord(record):
    ...
    scraperwiki.sqlite.save(unique_keys=['key'], table_name=dataTable, data= record )
...
def parseEpisodesData(seriesData,episodesData):
    ...
    for programme in episodesData['episodes']:
        ...
        #record['medium_synopsis']=episode['medium_synopsis']
...
getSeriesData(bottomLineSeriesID)import scraperwiki, simplejson,urllib,string
...
getSeriesData(bottomLineSeriesID)