...
<html>
  ...
  <script>
    ...
    var formatter = new google.visualization.PatternFormat('<a href="http://openlearn.open.ac.uk/course/view.php?name={0}">{0}</a>');
    ...
    var stringFilter = new google.visualization.ControlWrapper({
      ...
      'options': {
        'filterColumnLabel': 'Learning Outcome',
        'matchType': 'any'
      }
    });
...
description = {"ccu": ("string", "Unitcode"),"lo": ("string", "Learning Outcome")}

data_table = gviz_api.DataTable(description)
data_table.LoadData(data)

json = data_table.ToJSon(columns_order=("ccu","lo" ),order_by="ccu")
