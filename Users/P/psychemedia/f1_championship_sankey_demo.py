...
"""
x='https://views.scraperwiki.com/run/ergast_championship_nodelist/'
#x='http://bost.ocks.org/mike/sankey/energy.json'
json=simplejson.load(urllib.urlopen(x))

print page_template % vars()import scraperwiki,simplejson,urllib
