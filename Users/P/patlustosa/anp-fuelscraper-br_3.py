...
def listaCidadesFaltando():
    ...
    cities_list = scraperwiki.sqlite.execute('select id, cod_municipio, nome from cities where  id in (1102, 1078, 1047, 909, 793, 678, 536, 1045, 489, 736, 461,443, 669, 479, 982, 394)')
...
populaTabelaPrecoCombustivel(656)
