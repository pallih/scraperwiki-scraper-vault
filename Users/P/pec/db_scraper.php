...
$stations = array(
    ...
    "MÃ¼nchen" => "M%FCnchen%20Hbf%238000261",
            ...
            if ($time != null && $time->find('a', 0) == null) {
                ...
                if ($train != null) {
                    ...
                    if ($ris != null) {
                        ...
                        $m = array();
                        if (preg_match('/ca. (\d+) Minuten spÃ¤ter/', $late, $m) > 0) {
                            $minutes = $m[1];
                        } else {
                            $minutes = "";
                        }
                    ...
                    $canceled = $reason == "Zug fÃ¤llt aus" ? "canceled" : "";
...
function s($s) {
    return str_replace(array('&nbsp;','&#252;','&#228;','&#246;','&#220;','&#196;'), array(' ','Ã¼','Ã¤','Ã¶','Ãœ','Ã„'), $s);
}
