import scraperwiki
sourcescraper = "virginia_dangerous_dogs"

scraperwiki.sqlite.attach(sourcescraper, "src")

sdata = scraperwiki.sqlite.execute("select * from src.dog_details")
keys = sdata.get("keys")
rows = sdata.get("data")
...
print '<h2>Virginia dangerous dogs</h2>'
print '<h3>Statistics on data from the <a href="http://scraperwiki.com/scrapers/virginia_dangerous_dogs/">Virginia dangerous dogs scraper</a></h3>'
print "<dl>"
for key in keys:
