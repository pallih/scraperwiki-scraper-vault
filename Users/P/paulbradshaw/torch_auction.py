...
scrape_and_look_for_next_link(startingurl)#This runs on a loop because the last page is formatted differently, but the unique key means there are no duplicate entries
#Just stop this running after 60 rows have been filled
