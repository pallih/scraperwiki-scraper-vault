...
#this proxy requires us to encode the url in b64
#query=Base64.encode64("http://www.indeed.co.za/jobs?q="+queries[j])
queryurl="http://serversystem.info/index.php?____pgfa=aHR0cDovL3d3dy5pbmRlZWQuY28uemEvam9icw%253D%253D&q="+queries[j]
#puts queryurl
#  doc = Nokogiri::HTML(open(queryurl))
agent = Mechanize.new
#agent.set_proxy "125.253.101.37", 8080
cookie = Mechanize::Cookie.new(  
   "domain"=> ".serversystem.info",
    "expirationDate"=> 1427469681,
    "hostOnly"=> false,
    "httpOnly"=> false,
    "name"=> "__utmv",
    "path"=> "/",
    ...
    "session"=> false,
    "storeId"=> "0",
    "value"=> "154973370.|4=semRevTest=-1=1" )
#    "domain"=> ".serversystem.info",
#    "expirationDate"=> 1901264011.967715,
#    "hostOnly"=> false,
#    "httpOnly"=>false,
#    "name"=> "COOKIE%253BCTK%253B%252F%253Bwww.indeed.co.za",
#    "path"=> "/",
#    "secure"=> false,
#    "session"=> false,
#    "storeId"=> "0",
#    "value"=> "17mm2jui414524rk%253B")
cookie.domain = ".serversystem.info"
cookie.path = "/"
page = agent.get("http://serversystem.info")
