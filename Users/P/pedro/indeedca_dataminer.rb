...
cookie = Mechanize::Cookie.new(   
   "domain"=>"www.hidemenow.net",
    ...
    "session"=> true,
    "storeId"=> "0",
    "value"=> "6blrsmjbh9efqnfsfcm85bdd06")

cookie.domain = "www.hidemenow.net"
cookie.path = "/"
page = agent.get("http://www.hidemenow.net")
