...
query="http://www.indeed.com.au/jobs?q="+queries[j]+"&l="
queryurl="http://unlimitaccess4u.com/browse.php?u="+query+"&b=28&f=norefer"
#puts queryurl
#  doc = Nokogiri::HTML(open(queryurl))
agent = Mechanize.new
#agent.set_proxy "125.253.101.37", 8080
cookie = Mechanize::Cookie.new(   
    "domain"=> "unlimitaccess4u.com",
    "hostOnly"=> true,
    "httpOnly"=> false,
    "name"=> "s",
    "path"=> "/",
    ...
    "session"=> true,
    "storeId"=> "0",
    "value"=> "e7odgrhbeu89ctrfto6co5oqc4")

cookie.domain = "unlimitaccess4u.com/"
cookie.path = "/"
page = agent.get("http://unlimitaccess4u.com/")
