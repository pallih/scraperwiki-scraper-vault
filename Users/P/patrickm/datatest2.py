...
Description: hashtag used for this dataset: #occupyGezi Dataset of tweets that are collected for further analysis and visualisation. 
...
for page in range(1, NUM_PAGES+1):
    ...
    try:
        ...
        for result in results_json['results']:
            print result
            scrapewiki.sqlite.save(["id"], result)
