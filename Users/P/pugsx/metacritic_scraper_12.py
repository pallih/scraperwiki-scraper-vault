...
types = ['0','1','2','3','4','5']
for type in types:
    url = "http://www.metacritic.com/browse/games/release-date/available/xbox360/name?view=detailed&page=%s" % type
    ...
    for product in products:
        ...
        iskinect = product.xpath("div/div/div/div[@class='more_stats extended_stats']/ul[@class='more_stats']/li[@class='stat attributes']/span[2]/text()")
        if len(iskinect) != 1:
            data['kinect'] = -1
        else:
            data['kinect'] = str(iskinect[1])
        ...
        data['type'] = type
        scraperwiki.datastore.save(unique_keys=['title','image','url','rating','release','genre','publisher','kinect'], data=data)
