...
import scraperwiki
html = scraperwiki.scrape('http://www.homeandlearn.co.uk/java/java_arrays.html')
imageUrl="http://www.homeandlearn.co.uk/java/";
...
ps = root.cssselect('p[align=center] img ')
s1=""

print len(ps)
#print ps # get all the <td> tags
for p in ps:
    s=p.attrib['src']
    width=p.attrib['width']
    height=p.attrib['height']
    #print lxml.html.tostring(td) # the full HTML tag
    print imageUrl+s 
    print s.find("gif")
    print 'Width=', width
    print 'Height=',height 
    s1=s             # just the text inside the HTML tag
