...
for pageNo in range (1, 4):
    ...
    html = scraperwiki.scrape("http://www.sify.com/movies/moreheadlines/category/tamil/page/"+ str(pageNo) +".html")
    ...
    for i in range(0, len(bw_news_titles)):
        if bw_news_details[i].text_content() != "":
            ...
            scraperwiki.sqlite.save(unique_keys=['index'], table_name="newsData", data=data)import scraperwiki
import lxml.html
import re
