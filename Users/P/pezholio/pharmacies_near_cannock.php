...
for ($i = 1; $i <= 5; $i++) {
    ...
    $html = scraperWiki::scrape("http://www.nhs.uk/ServiceDirectories/Pages/ServiceResults.aspx?Postcode=WS11%201BG&Coords=3104,3981&ServiceType=Pharmacy&JScript=1&PageCount=10&PageNumber=". $i); 
