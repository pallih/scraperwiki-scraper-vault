...
uri = 'http://www.whatdotheyknow.com/request/119687/response/296922/attach/3/CMD%20Extract%20All.zip'
source = open(uri)

zip = Zip::ZipFile.open(source.path, Zip::ZipFile::CREATE)
result = zip.read('Whittaker Extract All.txt')
