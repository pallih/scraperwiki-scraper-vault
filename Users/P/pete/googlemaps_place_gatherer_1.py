...
def get_inputs(start_url):
    ...
    coordinates = "location=40.795098,-73.967617" #Enter latitude and longitude of central point; be sure to change street in loop below
    radius = "&radius=1000"
    sensor = "&sensor=false"
    establishment_type = ['accounting', 'cpa']
