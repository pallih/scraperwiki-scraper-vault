                ...
                if(k==""):
                    ...
                    for l in response.cssselect("tr.GridRows td"):
                        ...
                        if l_c<3:
                            ...
                            data.append(row)
                            print data
                            scraperwiki.sqlite.save(unique_keys=["S_no"],data={"S_no":s_no,"Column1":row[0],"Column2":row[1],"Column3":row[2],"Column4":row[3],"State":'Uttar Pradesh',"district":district[districtstore],"town":town[townstore]})
                            s_no+=2
                            row=[]
                    s_no=serial+1
