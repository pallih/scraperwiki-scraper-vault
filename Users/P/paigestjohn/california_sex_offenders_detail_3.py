...
scraperwiki.sqlite.execute("CREATE TABLE IF NOT EXISTS `addresses`(`addresses` text, `uniqueid` text)")

scraperwiki.sqlite.execute("CREATE TABLE IF NOT EXISTS `aliases` (`alias` text, `uniqueid` text)")

scraperwiki.sqlite.execute("CREATE TABLE IF NOT EXISTS `marks` (`uniqueid` text, `marks` text)")

scraperwiki.sqlite.execute("CREATE TABLE IF NOT EXISTS `swvariables` (`value_blob` blob, `type` text, `name` text)")
