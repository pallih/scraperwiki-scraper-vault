...
import scraperwiki
html = scraperwiki.scrape('http://www.capitalgrowth.org/spaces/?id=494&postcode=&borough=1&limit_start=0&submit=submit')
...
el = root.cssselect("div.featured b")
...
for el in root.cssselect("div.featured b"):
    print el
