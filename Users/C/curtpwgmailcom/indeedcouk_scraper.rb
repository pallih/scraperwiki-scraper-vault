...
feeds = [("http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Daa&max=10&links=preserve&exc=&submit=Create+Feed",
         ("http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Daz&max=100&links=preserve&exc=&submit=Create+Feed")]
...
for feed in feeds
  for location in locations
    ...
    start=0
      ...
      loop do
        queryurl="http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Daa&max=10&links=preserve&exc=&submit=Create+Feed"
        sleep 1.5
