...
for masterindex in range(len(masteralph)):       
    for index in range(len(alphabet)):       
        ...
        for p in xrange(pagenum):
            ...
            sourcearray = ["http://www.jobgymn.com/makefulltextfeed.php?url=newyork.craigslist.org%2Fsearch%2Fjjj%3Fquery%3D", masteralph[masterindex], alphabet[index],    "%26srchType%3DA%26format%3Drss&max=500&paged=", str(p), "&submit=Create+Feed&links=preserve"]
