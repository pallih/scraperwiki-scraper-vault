...
feeds = [
    {"baseURL":"http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Daa&max=30&links=preserve&exc=&submit=Create+Feed"},
    {"baseURL":"http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Dab&max=30&links=preserve&exc=&submit=Create+Feed"},
    {"baseURL":"http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Dac&max=30&links=preserve&exc=&submit=Create+Feed"},
    {"baseURL":"http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Dad&max=30&links=preserve&exc=&submit=Create+Feed"},
    {"baseURL":"http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Dae&max=30&links=preserve&exc=&submit=Create+Feed"},
    {"baseURL":"http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Daf&max=30&links=preserve&exc=&submit=Create+Feed"},
    {"baseURL":"http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Dag&max=30&links=preserve&exc=&submit=Create+Feed"},
    {"baseURL":"http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Dah&max=30&links=preserve&exc=&submit=Create+Feed"},
    {"baseURL":"http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Dai&max=30&links=preserve&exc=&submit=Create+Feed"},
    {"baseURL":"http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Daj&max=30&links=preserve&exc=&submit=Create+Feed"},
    {"baseURL":"http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Dak&max=30&links=preserve&exc=&submit=Create+Feed"},
  #  {"baseURL":"http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Dal&max=100&links=preserve&exc=&submit=Create+Feed"},
  #  {"baseURL":"http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Dam&max=100&links=preserve&exc=&submit=Create+Feed"},
  #  {"baseURL":"http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Dan&max=100&links=preserve&exc=&submit=Create+Feed"},
  #  {"baseURL":"http://rss.indeed.com/rss?q=ao"},
  #  {"baseURL":"http://rss.indeed.com/rss?q=ap"},
  #  {"baseURL":"http://rss.indeed.com/rss?q=aq"},
  #  {"baseURL":"http://rss.indeed.com/rss?q=ar"},
  #  {"baseURL":"http://rss.indeed.com/rss?q=as"},
  #  {"baseURL":"http://rss.indeed.com/rss?q=at"},
  #  {"baseURL":"http://rss.indeed.com/rss?q=au"},
  #  {"baseURL":"http://rss.indeed.com/rss?q=av"},
  #  {"baseURL":"http://rss.indeed.com/rss?q=aw"},
  #  {"baseURL":"http://rss.indeed.com/rss?q=ax"},
  #  {"baseURL":"http://rss.indeed.com/rss?q=ay"},   
    {"baseURL":"http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3Daz&max=30&links=preserve&exc=&submit=Create+Feed"}
]
...
def processFeed(feed):
    ...
    while True:
        ...
        if not processSegment(url, urlparse.urlunparse(parts)):
            break
        # CURT ADDED to short circuit when FiveFilter limit is reached
        if index >= 40:
            break
