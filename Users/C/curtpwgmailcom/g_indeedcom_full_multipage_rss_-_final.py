...
for index in range(len(alphabet)):       
    ...
    for p in xrange(pagenum):
        ...
        try:
            sourcearray = ["http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3D", masterletter, alphabet[index], "&max=100&paged=", str(p+1), "&submit=Create+Feed&links=preserve"]
