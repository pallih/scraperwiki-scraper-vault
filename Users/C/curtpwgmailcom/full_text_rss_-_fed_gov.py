...
feeds = [
    {"baseURL":"http://jobgymn.com/makefulltextfeed.php?url=https%3A%2F%2Fwww.usajobs.gov%2FJobSearch%2FSearch%2FRSSFeed%2F2568847&max=10&links=preserve&exc=&submit=Create+Feed"},
    {"baseURL":"http://rss.indeed.com/rss?q=ab"},
    {"baseURL":"http://rss.indeed.com/rss?q=ac"},
    {"baseURL":"http://rss.indeed.com/rss?q=ad"}
]
