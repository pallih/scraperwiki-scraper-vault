...
for i in range(len(alphabet)):       
    ...
    for p in range(len(pagenum)):
        ...
        sourcearray = ["http://www.jobgymn.com/makefulltextfeed.php?url=rss.indeed.com%2Frss%3Fq%3D", masterletter, alphabet[i], "&max=30&paged=", pagenum[p], "&submit=Create+Feed&links=preserve"]
