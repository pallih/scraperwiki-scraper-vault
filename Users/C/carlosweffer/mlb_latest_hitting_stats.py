...
#TWO Latest batting stats: results=2
    page_url = Template("http://mlb.mlb.com/lookup/json/named.mlb_bio_hitting_last_10.bam?results=7&season=2013&game_type='R'&player_id=$player_id").substitute(player_id=player_id)
...
#TWO Latest batting stats: results=2
    page_url = Template("http://mlb.mlb.com/lookup/json/named.mlb_bio_hitting_last_10.bam?results=8&season=2013&game_type='R'&player_id=$player_id").substitute(player_id=player_id)
    json1 = scraperwiki.scrape(page_url)
    #json1 = scraperwiki.scrape("http://mlb.mlb.com/lookup/json/named.mlb_bio_hitting_last_10.bam?results=2&season=2013&game_type='R'&player_id=462101")
    json_decode1 = demjson.decode(json1)
