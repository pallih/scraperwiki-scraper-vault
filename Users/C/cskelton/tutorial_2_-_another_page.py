...
import scraperwiki
html = scraperwiki.scrape('http://www.news.gov.bc.ca/')
...
tds = root.xpath(div[@class='headline']) # get all the <td> tags
for td in tds:
    print lxml.html.tostring(td) # the full HTML tag
    print td.text_contents()                # just the text inside the HTML tag
