...
result_url="http://bureau.espeakers.com/nsas/results.php?"
contact_url="http://bureau.espeakers.com/nsas/speaker.php?"
...
def main():
    ...
    for id in range(66):
        next_url=fullfetcher(result_url+next_url,False)
