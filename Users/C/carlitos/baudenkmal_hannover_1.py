...
category = "Fußballstadion_in_Österreich"

urlCategory = "http://de.wikipedia.org/w/api.php?action=query&list=categorymembers&cmtitle=Kategorie:Fußballstadion_in_Österreich&cmlimit=500&format=json"
