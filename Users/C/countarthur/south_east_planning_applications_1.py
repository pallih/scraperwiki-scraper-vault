...
auth_list = scrape_lib.get_auths(['Aylesbury Vale']) # NB simple string is a region, list is a list of authorities
#scrape_lib.gather_applications(auth_list[0], 500, 0, 10000)
#scrape_lib.gather_applications(auth_list[0], 2012-09-19, 2012-12-15, 10000)
scrape_lib.gather_applications(auth_list[0], 7, 0, 10000)
