...
NEIGHBORHOODS = ['dupont', 'silver spring', 'springfield', 'oxon hill', 'crystal city', 'alexandria', 'columbia heights', 'new york', 'k st', 'woodbridge', 'annandale', 'arlington', 'waldorf', 'manassas', 'dulles', 'laurel,' 'rockville', 'fairfax', 'tyson', 'capitol hill', 'college park', 'greenbelt']
...
#        try:
        linkhtml = scraperwiki.scrape(link).decode('latin_1')           # scrape the contents of the current link and decode from Latin-1 (ISO-8859-1) encoding
        print link
...
base_url = 'http://philadelphia.backpage.com/adult/'
