...
NEIGHBORHOODS = ['kendall', 'palmetto', 'south miami', 'lauderdale', 'airport', 'dade', ' doral', 'brickell', 'miami beach', 'aventura', 'coral gables', 'hialeah', 'miami lake', 'sunny isles', 'north miami', 'south beach,' 'rockville', 'fairfax', 'tyson', 'capitol hill', 'college park', 'greenbelt']
...
base_url = 'http://miami.backpage.com/adult/'
