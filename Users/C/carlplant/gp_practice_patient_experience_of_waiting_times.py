...
XLS = 'https://indicators.ic.nhs.uk/download/Patient%20experience/Data/2011-12/Normal%20waiting%20times.xls'
...
keys = sheet.row_values(13)
#keys = []
keys[14].replace("% 5 to 15 minutes","5to15")
...
idno = 0
for rownumber in range(19, sheet.nrows):
    ...
    for num in range(0,sheet.ncols):
        ...
        record[title[num]] = sheet.row_values(rownumber)[num]
    idno = idno + 1
    record['id'] = str(idno)
    print "---", record
