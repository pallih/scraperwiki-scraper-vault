...
html = scraperwiki.scrape("http://icasualties.org/OEF/Nationality.aspx?hndQry=UK")
...
for row in rows:
    ...
    if table_cells: 
        ...
        scraperwiki.sqlite.save(unique_keys=[], data={"Name":Name, "Date":Date, "Rank" : Rank, "Age":Age, "Unit": Unit, "Branch": Branch, "State": State, "City": City, "Cause": Cause, "Place_of_Death": Place_of_Death, "Died_In": Died_In })import scraperwiki           
import lxml.html
...
for row in rows:
    ...
    if table_cells: 
        ...
        scraperwiki.sqlite.save(unique_keys=[], data={"Name":Name, "Date":Date, "Rank" : Rank, "Age":Age, "Unit": Unit, "Branch": Branch, "State": State, "City": City, "Cause": Cause, "Place_of_Death": Place_of_Death, "Died_In": Died_In })