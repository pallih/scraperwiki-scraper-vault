# Here we're going to build an RSS feed from our News Data
from scraperwiki.apiwrapper import getKeys, getData, getDataByDate, getDataByLocation
from time import strptime, strftime, gmtime
from cgi import escape

sourcescraper = 'city-of-lincoln-council-latest-news-scrape'
...
print '  <channel>\n'
print '    <title>City of Lincoln Council Latest News</title>\n'
print '    <description>RSS feed for News Updates from the City of Lincoln Council</description>\n'
