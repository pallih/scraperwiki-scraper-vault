<?php
    ...
    $sourcescraper = 'property_scraper_2011';
    scraperwiki::attach($sourcescraper);

    $arraydata = scraperwiki::select(           
        "* from property_scraper_2011.swdata"
    );
         ...
         localSearch.setSearchCompleteCallback(null, 
          function() {
           ...
           {  
            ...
            //alert("Postcode "+localSearch.results[0]+" not found!"); - commented out
           }
          }); 
