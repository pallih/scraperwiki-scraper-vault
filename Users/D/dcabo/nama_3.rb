...
direccion = "http://gestiona.madrid.org/suju/servlet/Servidor?opcion=SUJUFichaSeleccionada&COD=38234&MONEDAACTIVA=EUROS"
...
columnas_poblacion = filas[0].search('td')
...
casilla_valor_poblacion = columnas_poblacion[1]

# Y ahora mostramos el resultado por pantalla
puts "La casilla que contiene la poblacion dice: "+casilla_valor_poblacion
puts "La casilla que contiene el precio dice: "+casilla_valor_precio
