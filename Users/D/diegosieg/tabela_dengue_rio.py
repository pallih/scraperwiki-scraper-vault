...
html = scraperwiki.scrape("http://200.141.78.79/dlstatic/10112/2352733/DLFE-259717.htm/Dadosdengue0.8.1.0.1.2.MES2.0.1.2..htm")
soup = BeautifulSoup(html)

tables = soup.find_all("table", {"class":"xl6818193"}) #"border" : "0", "cellspacing": "0", "cellpadding": "0"
print len(tables)
