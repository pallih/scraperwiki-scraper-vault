...
mech = Browser()
for i in (0,25,50,75,100,125,150,175,200,225,250,275,300,325):  #sorry guys, i have to make it static for page numbers
    url = "http://www.dikti.go.id/index.php?option=com_qcontacts&view=category&catid=64&Itemid=206&limitstart="
    url = url + str(i)
    page1 = mech.open(url)
    html1 = page1.read()
