...
mech = Browser()
for i in (0,25,50,75,100,125,150):  #sorry guys, i have to make it static for page numbers
    url = "http://www.dikti.go.id/index.php?option=com_qcontacts&view=category&catid=67&Itemid=209&limitstart="
    url = url + str(i)
    page1 = mech.open(url)
    html1 = page1.read()
