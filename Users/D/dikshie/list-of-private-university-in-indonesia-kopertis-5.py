...
mech = Browser()
for i in (0,25,50,75,100):  #sorry guys, i have to make it static for page numbers
    url = "http://www.dikti.go.id/index.php?option=com_qcontacts&view=category&catid=60&Itemid=202&limitstart="
    url = url + str(i)
    page1 = mech.open(url)
    html1 = page1.read()
