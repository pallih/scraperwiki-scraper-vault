...
function fourOhFour($html){
 ...
 scraperwiki::attach("holidaylettings_summary") ;
 $cottData = scraperwiki::select("COTTAGE_ID, COTTAGE_URL from 'holidaylettings_summary'.SWDATA order by COTTAGE_ID");
