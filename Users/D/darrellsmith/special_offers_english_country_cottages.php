...
function getFromMonth($str){
  ...
  function getToDate($str,$monthToFind){
   ...
   $url = "http://www.helpfulholidays.com/advresults.asp?page_no=".$i."&r=0.3398183";
   ...
   print_r($dom->find('div[class=default_box]'));

echo $url;
   foreach($dom->find('div[class=default_box]') as $data){ 
     echo $data;
     foreach($data->find('div[class=gen11]') as $element){ 
        echo $element;
     }
#  foreach($data->find('img') as $image){
#     echo "there";
#  }
   }
