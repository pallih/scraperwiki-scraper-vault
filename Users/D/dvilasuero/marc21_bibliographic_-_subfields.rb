...
base_url = "http://www.loc.gov/marc/bibliographic/"
index_page = "bdsummary.html"
        ...
        sfs.each do |sf|
          if sf.strip.length >0
            ...
            begin
              ...
              ScraperWiki.save(unique_keys=["tag", "subfield"],data={'tag' => mt.tag, 'uri' => mt.uri, 'subfield' => xs[0].strip, 'repeatable' => xs[1].strip.chomp(')')})
            rescue
