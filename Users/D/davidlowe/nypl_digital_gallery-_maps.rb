...
def action()
  br = Mechanize.new { |b|
    ...
    s_url = get_metadata("SUB_URL","dgkeysearchresult.cfm?word=div_id%3Ahm&sScope=images&sLabel=The%20Lionel%20Pincus%20and%20Princess%20Firyal%20Map%20Division")
  begin
