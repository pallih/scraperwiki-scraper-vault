...
def action()
  br = Mechanize.new { |b|
    ...
    s_url = get_metadata("SUB_URL","dgkeysearchresult.cfm?word=div_id%3Ahsb&sScope=images&sLabel=Henry%20W%2E%20and%20Albert%20A%2E%20Berg%20Collection%20of%20English%20and%20American%20Literature")
  begin
