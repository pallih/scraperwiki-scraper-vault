...
def action()
  br = Mechanize.new { |b|
    ...
    s_url = get_metadata("SUB_URL","dgkeysearchresult.cfm?word=&d=hsh&sScope=Library+Division&sLabel=Photography+Collection%2C+Miriam+and+Ira+D.+Wallach+Division+of+Art%2C+Prints+and+Photographs")
  begin
