...
def action()
  br = Mechanize.new { |b|
    ...
    s_url = get_metadata("SUB_URL","dgkeysearchresult.cfm?word=div_id%3Ahh&sScope=images&sLabel=Irma%20and%20Paul%20Milstein%20Division%20of%20United%20States%20History%2C%20Local%20History%20and%20Genealogy")
  begin
