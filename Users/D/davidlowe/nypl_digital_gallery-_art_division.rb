...
def action()
  br = Mechanize.new { |b|
    ...
    s_url = get_metadata("SUB_URL","dgkeysearchresult.cfm?word=div_id%3Aha&sScope=images&sLabel=Art%20and%20Architecture%20Collection%2C%20Miriam%20and%20Ira%20D%2E%20Wallach%20Division%20of%20Art%2C%20Prints%20and%20Photographs")
  begin
