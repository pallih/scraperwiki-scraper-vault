...
//data
$arrData = array(
   '0'  => array('klant' => 'Wijs', 'thema' => 'online marketing', 'keywords' => 'seo, sea, web analytics', 'sites' => 'reference.be, the-aim.be, proximedia.be, scoutsgullegemmoorsele.be')
);
...
if(preg_match('/http:\/\/(?!www)(.*)/',$url)){
    ...
    echo '3: - http://www.'.$homepage.$url;
}else{
    echo '4: - http://www.'.$homepage.'/'.$url;
}
