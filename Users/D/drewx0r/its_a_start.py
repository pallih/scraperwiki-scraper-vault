...
from datetime import datetime, date, time                       # time is on my side. (date operations)
import codecs
import base64
import urllib
...
#        try:
        linkhtml = scraperwiki.scrape(link).decode('Windows-1252')          # scrape the contents of the current link and decode from Windows-1252 encoding
        print link
