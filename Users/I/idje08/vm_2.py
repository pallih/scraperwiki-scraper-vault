...
data = {
    'pinf_uio_app%252Fstructure%252Fpublic%252Flogin_login__username_value': 'ilovebicykles',
    'pinf_uio_app%252Fstructure%252Fpublic%252Flogin_login__password_value': 'fantafantafanta',
}

session.post('https://secure.ashleymadison.com/app/public/loginaction.p', data=data, verify=False)
data = {
    'sid': 'ENCODED:LVSWOKAWCABDNACCQA31133106504F15824IAAAA4NNIF',
    'pinf_action_UXVpY2tTZWFyY2g%3D_YXBwL3N0cnVjdHVyZS9wcml2YXRlL2hlYWRlci9tZW51':'1',
    'pinf_uio_app%2Fstructure%2Fprivate%2Fheader%2Fmenu_main__age_min_value':'30',
    'pinf_uio_app%2Fstructure%2Fprivate%2Fheader%2Fmenu_main__age_max_value':'30',
    'pinf_uio_app%2Fstructure%2Fprivate%2Fheader%2Fmenu_main__location_value':'0',
...
start = 0
base_url = 'http://www.ashleymadison.com/app/private/member/search/result.p?o=%s&geoFilter=0&loginStatus=0&ageFilter=30,30'
