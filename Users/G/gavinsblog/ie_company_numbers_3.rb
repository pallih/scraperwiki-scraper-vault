...
def scrape_table(page_body, register)
  ...
  data_table = data_rows.collect do |row|
    ...
    record['Status']     = (register == 'Previous' ? 'Dissolved' : 'Active') 
...
def run_from(prefix, register)
  ...
  loop do
    ...
    prefix = prefix.succ#increment_string(prefix)
  end
end
...
prefix = "000"#ScraperWiki.get_var('prefix', '000')
