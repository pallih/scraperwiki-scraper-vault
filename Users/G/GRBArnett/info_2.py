...
def scrape_table(root):
    ...
    #GA Same as above for administrator's address
    record['Admin address'] = search_xpath(root, "//span[@rel='organisation:hasOfficeAddress']//span[@property='vCard:label']")
    record['Admin address of company'] = search_by_span_attribute(root, "property", "organisation:hasOffice")
