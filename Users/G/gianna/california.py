...
# real scrape: extracting useful bits

print 'Extracting HTML...'
print html
root = lxml.html.fromstring(html)
# css/html classes to identify
for table in root.cssselect("table.wikitable.sortable"):
    for tr in table.cssselect('tr'):
        
        if(len(tr.cssselect("td")) and tr[0].text_content() != ""):
               # think about any possibilities: either 5 or 6 cells
            ...
            scraperwiki.sqlite.save(unique_keys=["location"], data={"location": location, "state": 'california', "city": city, "start_date": date, "estimated_attendance": people, "latitude":'', "longitude":''}, table_name="cities")
...
for location in locations:
    ...
    # "commit" is important, even though its not documented
