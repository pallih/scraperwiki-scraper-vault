...
foreach ($html->find("table#cps_eande_m13 tr") as $el) {
    ...
    // don't store these values
    if (in_array($age, array('16 years and over', '16 to 19 years', '25 to 34 years', '25 to 54 years', '65 years and over', '75 years and over'))) {
        continue;
    }
    if ($sex == 'TOTAL') {
        continue;
    ...
    $data = array(
        ...
        'sex' => $sex,
        'race' => $race,
        'civilian_noninstitional_population' => str_replace(',', '', $population),
        'total_civilian_labor_force' => str_replace(',', '', $total_in_labor_force),
        'percent_of_population_in_labor_force' => $per_of_pop_in_labor,
        'total_employed_in_labor_force' => str_replace(',', '', $total_employed),
        'percent_employed_in_labor_force' => $per_employed,
        'total_unemployed_in_labor_force' => str_replace(',', '', $total_unemployed),
        'percent_unemployed_in_labor_force' => $per_unemployed,
        'not_in_labor_force' => str_replace(',', '', $not_in_labor_force)
    );    
