...
for row in rows:
    ...
    if rownum == 2:
            if rowprogress > 20:
                ...
                titlefull2 = titlestart2 + 'target="_blank" style="color:white; text-decoration:none;" ' + titleend2
                titlefull2.lstrip()
            ...
            if rowprogress > 20:
                print "<td style='text-align:center; background-color:#E8E8E8; padding:5px 5px 5px 5px;'>", row.pop(0), "</td>"
                ...
                companyfull2 = companystart2 + 'target="_blank" style="text-decoration:none; ' + companyend2   
                companyfull2.lstrip()
            ...
            if rowprogress > 20:
                print "<td style='text-align:center; background-color:#F0F0F0; padding:5px 5px 5px 5px;'>", row.pop(0), "</td>"
