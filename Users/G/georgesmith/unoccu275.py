...
QUERY = 'occupygezi%20-rt%20-RT%20-direngeziparki%20-direntaksim%20-direnankara%20-direnturkiyem%20-tayipistifa%20-oyunagelmeturkiyem'

since = '2013-05-27'
until = '2013-05-27'
lang = 'tr'
geo = '41.005462,28.974853,20mi'
...
for page in range(1, NUM_PAGES+1): 
    base_url = 'http://search.twitter.com/search.json?q=%s&since=%s&until=%s&lang=%s&geo=%s&rpp=%s&page=%s' \
        % (urllib2.quote(QUERY), since, until, lang, geo, RESULTS_PER_PAGE, page)
    try:
