...
Dataset Name: #direntaksim  
Dataset URI: https://github.com/PatrickMcGee/OpenData 
Author: Patrick McGee 
Author URI: http://www.patrickmcgee.co.uk 
Description: hashtag used for this dataset: #direntaksim Dataset of tweets that are collected for further analysis and visualisation. 
