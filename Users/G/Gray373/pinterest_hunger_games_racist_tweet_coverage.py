...
html = scraperwiki.scrape("http://pinterest.com/search/?q=hunger+games+racist")
import lxml.html           
...
for pin in root.cssselect("#wrapper .pin"):
    ...
    import urllib
    pinpage = lxml.html.fromstring(urllib.urlopen("http://pinterest.com/pin/"+data['id']).read())
