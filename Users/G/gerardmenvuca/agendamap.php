...
<h2>General Map Thing of <br/> <span id="scrapername">...</span> <em id="message">...</em></h2>
...
var sourcescraper = 'agenda_draguignan';
var src ="";
...
{
    src=record['SOURCE'];
     strhtml=eval(record['AGENDA']);
    return '<a href="'+record['SOURCE']+'" target="_blank">'+record["VILLE"]+' '+record["CP"]+'</a><br /><small>Source : '+record['SOURCE']+'</small><br>'+strhtml;
}
...
function loaddata() 
{
    ...
    function format_agenda(o){

        var ctent = o.results[0];
        var nhref='href="'+src;
        return ctent.replace(/href="/gi,nhref);
