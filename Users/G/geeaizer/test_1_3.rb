...
ScraperWiki.save_sqlite(unique_keys=['Rank'], data=data)html = ScraperWiki.scrape("http://www.amazon.com/best-sellers-movies-TV-DVD-Blu-ray/zgbs/movies-tv/ref=pd_ts_zgc_mov_movies-tv_morl?pf_rd_p=1326658342&pf_rd_s=right-4&pf_rd_t=101&pf_rd_i=2625373011&pf_rd_m=ATVPDKIKX0DER&pf_rd_r=0FQ5NXJMNQJ0F3PJ6RAD")
