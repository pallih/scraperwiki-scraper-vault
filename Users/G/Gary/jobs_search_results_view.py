...
sourcescraper = "jobs_search_results"
limit = 45
offset = 0
...
for row in rows:
    ...
    if rownum == 2:
            if rowprogress > 30:
                titlefull2 = "<a title='View this job' target='_blank' style='color:white; text-decoration:underline;'" + row.pop(1) + "</a>"
                titlefull2.lstrip()
