import scraperwiki
html = scraperwiki.scrape("http://www.gaepd.org/pls/enfo/epdorders.p_orders")
import lxml.html
...
for td in root.cssselect("table"): #read backwards: "find every table that is in the website and consider its <td>   tags
    ...
    data = { #boilerplate, i guess
      'commentto' : tds[17].text_content(),
      'dateclose' : tds[15].text_content(),
