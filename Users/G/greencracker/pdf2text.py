...
url = "http://greencracker.net/wp-content/uploads/2013/04/ExportReportToPDF.pdf"
pdfdata = urllib2.urlopen(url).read()
print "The pdf file has %d bytes" % len(pdfdata)

xmldata = scraperwiki.pdftoxml(pdfdata)
print "After converting to xml it has %d bytes" % len(xmldata)
print "The first 2000 characters are: ", xmldata[:10000000000]
...
page = pages[0]
for el in list(page)[:1]:
    if el.tag == "text font = 2":
